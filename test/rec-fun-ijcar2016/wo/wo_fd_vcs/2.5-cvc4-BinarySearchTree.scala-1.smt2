...
(assert (exists ((t!205 Tree!926)) (not (bvsge (ite ((_ is Leaf!927) t!205) (_ bv1 32) (ite ((_ is Node!928) t!205) (bvadd (bvadd (size!206 (left!929 t!205)) (_ bv1 32)) (size!206 (right!931 t!205))) error_value!933)) (_ bv1 32))) ))
(check-sat)
(exit)
