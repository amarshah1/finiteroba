...
(assert (exists ((h!234 Heap!1189) (l!233 List!1196)) (not (=> (hasLeftistProperty!210 h!234) (and (and (hasLeftistProperty!210 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209))) (hasLeftistProperty!210 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209)))) (= (bvadd (heapSize!212 h!234) (listSize!229 l!233)) (heapSize!212 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209))))))) ))
(check-sat)
(exit)
