...
(assert (exists ((heap!221 Heap!1069) (element!220 (_ BitVec 32))) (not (=> (hasLeftistProperty!210 heap!221) (= (heapSize!212 (merge!215 (Node!1071 (_ bv1 32) element!220 Leaf!1070 Leaf!1070) heap!221)) (bvadd (heapSize!212 heap!221) (_ bv1 32))))) ))
(check-sat)
(exit)
