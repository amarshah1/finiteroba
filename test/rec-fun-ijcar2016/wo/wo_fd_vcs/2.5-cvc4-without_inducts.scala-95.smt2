...
(assert (exists ((n!486 Nat!2424) (xs!487 Lst!2428)) (not (or (or (not (less!231 n!486 (len!254 xs!487))) (not (less!231 n!486 (len!254 xs!487)))) (= (last!265 (drop!257 n!486 xs!487)) (last!265 xs!487)))) ))
(check-sat)
(exit)
