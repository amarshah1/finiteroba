...
(assert (exists ((acc!216 Int) (l!215 List!1044)) (not (=> (>= acc!216 (- 0)) (= (ite ((_ is Nil!1048) l!215) acc!216 (ite ((_ is Cons!1045) l!215) (sizeTailRecAcc!217 (tail!1047 l!215) (+ acc!216 1)) error_value!1051)) (+ (size!206 l!215) acc!216)))) ))
(check-sat)
(exit)
