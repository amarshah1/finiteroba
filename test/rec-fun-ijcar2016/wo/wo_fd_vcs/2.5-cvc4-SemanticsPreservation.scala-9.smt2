...
(assert (exists ((formula!209 Formula!1022)) (not (=> (and (and (and ((_ is Or!1028) formula!209) ((_ is Or!1028) formula!209)) (= (ite ((_ is And!1023) (lhs!1029 formula!209)) (and (and (eval!210 (lhs!1024 (lhs!1029 formula!209))) (eval!210 (lhs!1024 (lhs!1029 formula!209)))) (eval!210 (rhs!1025 (lhs!1029 formula!209)))) (ite ((_ is Or!1028) (lhs!1029 formula!209)) (or (or (eval!210 (lhs!1029 (lhs!1029 formula!209))) (eval!210 (lhs!1029 (lhs!1029 formula!209)))) (eval!210 (rhs!1030 (lhs!1029 formula!209)))) (ite ((_ is Not!1026) (lhs!1029 formula!209)) (not (eval!210 (f!1027 (lhs!1029 formula!209)))) (ite ((_ is Variable!1031) (lhs!1029 formula!209)) (bvsgt (id!1032 (lhs!1029 formula!209)) (_ bv42 32)) error_value!1036)))) (eval!210 (nnf!206 (lhs!1029 formula!209))))) (= (ite ((_ is And!1023) (rhs!1030 formula!209)) (and (and (eval!210 (lhs!1024 (rhs!1030 formula!209))) (eval!210 (lhs!1024 (rhs!1030 formula!209)))) (eval!210 (rhs!1025 (rhs!1030 formula!209)))) (ite ((_ is Or!1028) (rhs!1030 formula!209)) (or (or (eval!210 (lhs!1029 (rhs!1030 formula!209))) (eval!210 (lhs!1029 (rhs!1030 formula!209)))) (eval!210 (rhs!1030 (rhs!1030 formula!209)))) (ite ((_ is Not!1026) (rhs!1030 formula!209)) (not (eval!210 (f!1027 (rhs!1030 formula!209)))) (ite ((_ is Variable!1031) (rhs!1030 formula!209)) (bvsgt (id!1032 (rhs!1030 formula!209)) (_ bv42 32)) error_value!1037)))) (eval!210 (nnf!206 (rhs!1030 formula!209))))) (= (ite ((_ is And!1023) formula!209) (and (and (eval!210 (lhs!1024 formula!209)) (eval!210 (lhs!1024 formula!209))) (eval!210 (rhs!1025 formula!209))) (ite ((_ is Or!1028) formula!209) (or (or (eval!210 (lhs!1029 formula!209)) (eval!210 (lhs!1029 formula!209))) (eval!210 (rhs!1030 formula!209))) (ite ((_ is Not!1026) formula!209) (not (eval!210 (f!1027 formula!209))) (ite ((_ is Variable!1031) formula!209) (bvsgt (id!1032 formula!209) (_ bv42 32)) error_value!1038)))) (eval!210 (nnf!206 formula!209))))) ))
(check-sat)
(exit)
