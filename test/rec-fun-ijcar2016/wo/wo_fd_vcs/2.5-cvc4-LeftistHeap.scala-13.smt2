...
(assert (exists ((heap!221 Heap!1018) (element!220 (_ BitVec 32))) (not (=> (hasLeftistProperty!208 heap!221) (= (size!210 (merge!215 (Node!1020 (_ bv1 32) element!220 Leaf!1019 Leaf!1019) heap!221)) (bvadd (size!210 heap!221) (_ bv1 32))))) ))
(check-sat)
(exit)
