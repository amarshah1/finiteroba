...
(assert (exists ((xs!557 Lst!2689) (ys!558 Lst!2689)) (not (or (or (not (= (len!254 xs!557) (len!254 ys!558))) (not (= (len!254 xs!557) (len!254 ys!558)))) (= (zip!288 (rev!275 xs!557) (rev!275 ys!558)) (zrev!299 (zip!288 xs!557 ys!558))))) ))
(check-sat)
(exit)
