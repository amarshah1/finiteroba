...
(assert (exists ((l!205 IList!903)) (not (bvsge (ite ((_ is Nil!907) l!205) (_ bv0 32) (ite ((_ is Cons!904) l!205) (bvadd (_ bv1 32) (listSize!206 (tail!906 l!205))) error_value!909)) (_ bv0 32))) ))
(check-sat)
(exit)
