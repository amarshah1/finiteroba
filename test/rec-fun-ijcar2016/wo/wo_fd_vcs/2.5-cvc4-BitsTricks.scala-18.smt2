...
(assert (exists ((n!240 (_ BitVec 32)) (x!239 (_ BitVec 32))) (not (=> (and (and (bvsge n!240 (_ bv0 32)) (bvsge n!240 (_ bv0 32))) (bvslt n!240 (_ bv32 32))) (isRotationLeft!238 x!239 (bvor (bvshl x!239 n!240) (bvlshr x!239 (bvsub (_ bv32 32) n!240))) n!240 (_ bv0 32)))) ))
(check-sat)
(exit)
