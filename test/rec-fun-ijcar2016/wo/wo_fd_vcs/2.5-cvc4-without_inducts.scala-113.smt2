...
(assert (exists ((n!545 Nat!2620) (xs!546 Lst!2624) (ys!547 Lst!2624)) (not (= (ztake!297 n!545 (zip!288 xs!546 ys!547)) (zip!288 (take!260 n!545 xs!546) (take!260 n!545 ys!547)))) ))
(check-sat)
(exit)
