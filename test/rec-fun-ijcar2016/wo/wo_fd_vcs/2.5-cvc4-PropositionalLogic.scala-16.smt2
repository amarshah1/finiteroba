...
(assert (exists ((f!217 Formula!1172)) (not (=> (and (and (and (and ((_ is Implies!1176) f!217) ((_ is Implies!1176) f!217)) (isNNF!212 f!217)) (=> (isNNF!212 (lhs!1177 f!217)) (isNNF!212 (simplify!206 (lhs!1177 f!217))))) (=> (isNNF!212 (rhs!1178 f!217)) (isNNF!212 (simplify!206 (rhs!1178 f!217))))) (isNNF!212 (simplify!206 f!217)))) ))
(check-sat)
(exit)
