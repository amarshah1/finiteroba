...
(assert (exists ((tab!211 array!896)) (not (=> (and (and (bvsge (size!898 tab!211) (_ bv0 32)) (bvsge (size!898 tab!211) (_ bv0 32))) (bvsge (size!898 tab!211) (_ bv0 32))) (isPositive!206 (_1!902 (while0!216 (array!896!897 (size!898 tab!211) arrayconst!910) (_ bv0 32) tab!211)) (size!898 (_1!902 (while0!216 (array!896!897 (size!898 tab!211) arrayconst!910) (_ bv0 32) tab!211)))))) ))
(check-sat)
(exit)
