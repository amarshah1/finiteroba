...
(assert (exists ((l!205 TokenList!939)) (not (bvsge (ite ((_ is Nil!943) l!205) (_ bv0 32) (ite ((_ is Cons!940) l!205) (bvadd (_ bv1 32) (size!206 (tail!942 l!205))) error_value!954)) (_ bv0 32))) ))
(check-sat)
(exit)
