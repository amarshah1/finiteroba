...
(assert (exists ((l!256 List!1266) (e!255 (_ BitVec 32)) (n!254 (_ BitVec 32))) (not (=> ((_ is Nil!1270) l!256) (or (or (not (and (and (contains!209 l!256 e!255) (contains!209 l!256 e!255)) (= e!255 n!254))) (not (and (and (contains!209 l!256 e!255) (contains!209 l!256 e!255)) (= e!255 n!254)))) (contains!209 (equals!239 n!254 l!256) e!255)))) ))
(check-sat)
(exit)
