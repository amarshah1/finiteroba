...
(assert (exists ((stat!216 Statement!1828)) (not (=> (and (and ((_ is While!1847) stat!216) ((_ is While!1847) stat!216)) (isForFree!225 (ite ((_ is Block!1832) (body!1849 stat!216)) (Block!1832 (eliminateForLoopsList!215 (body!1833 (body!1849 stat!216)))) (ite ((_ is IfThenElse!1839) (body!1849 stat!216)) (IfThenElse!1839 (expr!1840 (body!1849 stat!216)) (eliminateForLoops!217 (then!1841 (body!1849 stat!216))) (eliminateForLoops!217 (elze!1842 (body!1849 stat!216)))) (ite ((_ is While!1847) (body!1849 stat!216)) (While!1847 (expr!1848 (body!1849 stat!216)) (eliminateForLoops!217 (body!1849 (body!1849 stat!216)))) (ite ((_ is For!1834) (body!1849 stat!216)) (Block!1832 (Cons!1890 (eliminateForLoops!217 (init!1835 (body!1849 stat!216))) (Cons!1890 (While!1847 (expr!1836 (body!1849 stat!216)) (Block!1832 (Cons!1890 (eliminateForLoops!217 (body!1838 (body!1849 stat!216))) (Cons!1890 (eliminateForLoops!217 (step!1837 (body!1849 stat!216))) Nil!1893)))) Nil!1893))) (body!1849 stat!216))))))) (isForFree!225 (ite ((_ is Block!1832) stat!216) (Block!1832 (eliminateForLoopsList!215 (body!1833 stat!216))) (ite ((_ is IfThenElse!1839) stat!216) (IfThenElse!1839 (expr!1840 stat!216) (eliminateForLoops!217 (then!1841 stat!216)) (eliminateForLoops!217 (elze!1842 stat!216))) (ite ((_ is While!1847) stat!216) (While!1847 (expr!1848 stat!216) (eliminateForLoops!217 (body!1849 stat!216))) (ite ((_ is For!1834) stat!216) (Block!1832 (Cons!1890 (eliminateForLoops!217 (init!1835 stat!216)) (Cons!1890 (While!1847 (expr!1836 stat!216) (Block!1832 (Cons!1890 (eliminateForLoops!217 (body!1838 stat!216)) (Cons!1890 (eliminateForLoops!217 (step!1837 stat!216)) Nil!1893)))) Nil!1893))) stat!216))))))) ))
(check-sat)
(exit)
