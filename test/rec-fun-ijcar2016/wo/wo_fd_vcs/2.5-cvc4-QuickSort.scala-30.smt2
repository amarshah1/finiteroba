...
(assert (exists ((l!252 List!1252) (e!251 (_ BitVec 32)) (n!250 (_ BitVec 32))) (not (=> ((_ is Nil!1256) l!252) (or (or (not (and (and (contains!209 l!252 e!251) (contains!209 l!252 e!251)) (bvsgt e!251 n!250))) (not (and (and (contains!209 l!252 e!251) (contains!209 l!252 e!251)) (bvsgt e!251 n!250)))) (contains!209 (greater!227 n!250 l!252) e!251)))) ))
(check-sat)
(exit)
