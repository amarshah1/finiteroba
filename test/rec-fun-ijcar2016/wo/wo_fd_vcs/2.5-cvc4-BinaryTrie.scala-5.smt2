...
(assert (exists ((t!211 Tree!929) (inp!210 IList!935)) (not (bvsge (bvadd (height!209 (ite ((_ is Leaf!930) t!211) (ite ((_ is Nil!939) inp!210) t!211 (ite ((_ is Cons!936) inp!210) (ite ((_ is Leaf!930) (insert!212 (tail!938 inp!210) Leaf!930)) (Node!931 (head!937 inp!210) Leaf!930 Leaf!930) (ite ((_ is Node!931) (insert!212 (tail!938 inp!210) Leaf!930)) (ite (bvsgt (nvalue!932 (insert!212 (tail!938 inp!210) Leaf!930)) (_ bv0 32)) (Node!931 (head!937 inp!210) (insert!212 (tail!938 inp!210) Leaf!930) Leaf!930) (Node!931 (nvalue!932 (insert!212 (tail!938 inp!210) Leaf!930)) Leaf!930 (insert!212 (tail!938 inp!210) Leaf!930))) error_value!945)) error_value!946)) (ite ((_ is Node!931) t!211) (ite ((_ is Nil!939) inp!210) t!211 (ite (and (and ((_ is Cons!936) inp!210) ((_ is Cons!936) inp!210)) ((_ is Nil!939) (tail!938 inp!210))) t!211 (ite (and (and ((_ is Cons!936) inp!210) ((_ is Cons!936) inp!210)) ((_ is Cons!936) (tail!938 inp!210))) (ite (bvsgt (head!937 (tail!938 inp!210)) (_ bv0 32)) (Node!931 (nvalue!932 t!211) (insert!212 (tail!938 inp!210) (ite (bvsgt (head!937 (tail!938 inp!210)) (_ bv0 32)) (left!933 t!211) (right!934 t!211))) (right!934 t!211)) (Node!931 (nvalue!932 t!211) (left!933 t!211) (insert!212 (tail!938 inp!210) (ite (bvsgt (head!937 (tail!938 inp!210)) (_ bv0 32)) (left!933 t!211) (right!934 t!211))))) t!211))) error_value!947))) (height!209 t!211)) (listSize!206 inp!210))) ))
(check-sat)
(exit)
