...
(assert (exists ((list!215 List!929) (i!216 Int)) (not (ite (= (firstZero!211 list!215) i!216) (ite (contains!209 list!215 (_ bv0 32)) (firstZeroAtPos!214 list!215 i!216) (= i!216 (size!206 list!215))) true)) ))
(check-sat)
(exit)
