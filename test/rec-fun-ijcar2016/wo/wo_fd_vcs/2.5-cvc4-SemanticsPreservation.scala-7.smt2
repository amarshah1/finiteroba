...
(assert (exists ((formula!209 Formula!989)) (not (=> (and (and (and ((_ is And!990) formula!209) ((_ is And!990) formula!209)) (= (ite ((_ is And!990) (lhs!991 formula!209)) (and (and (eval!210 (lhs!991 (lhs!991 formula!209))) (eval!210 (lhs!991 (lhs!991 formula!209)))) (eval!210 (rhs!992 (lhs!991 formula!209)))) (ite ((_ is Or!995) (lhs!991 formula!209)) (or (or (eval!210 (lhs!996 (lhs!991 formula!209))) (eval!210 (lhs!996 (lhs!991 formula!209)))) (eval!210 (rhs!997 (lhs!991 formula!209)))) (ite ((_ is Not!993) (lhs!991 formula!209)) (not (eval!210 (f!994 (lhs!991 formula!209)))) (ite ((_ is Variable!998) (lhs!991 formula!209)) (bvsgt (id!999 (lhs!991 formula!209)) (_ bv42 32)) error_value!1003)))) (eval!210 (nnf!206 (lhs!991 formula!209))))) (= (ite ((_ is And!990) (rhs!992 formula!209)) (and (and (eval!210 (lhs!991 (rhs!992 formula!209))) (eval!210 (lhs!991 (rhs!992 formula!209)))) (eval!210 (rhs!992 (rhs!992 formula!209)))) (ite ((_ is Or!995) (rhs!992 formula!209)) (or (or (eval!210 (lhs!996 (rhs!992 formula!209))) (eval!210 (lhs!996 (rhs!992 formula!209)))) (eval!210 (rhs!997 (rhs!992 formula!209)))) (ite ((_ is Not!993) (rhs!992 formula!209)) (not (eval!210 (f!994 (rhs!992 formula!209)))) (ite ((_ is Variable!998) (rhs!992 formula!209)) (bvsgt (id!999 (rhs!992 formula!209)) (_ bv42 32)) error_value!1004)))) (eval!210 (nnf!206 (rhs!992 formula!209))))) (= (ite ((_ is And!990) formula!209) (and (and (eval!210 (lhs!991 formula!209)) (eval!210 (lhs!991 formula!209))) (eval!210 (rhs!992 formula!209))) (ite ((_ is Or!995) formula!209) (or (or (eval!210 (lhs!996 formula!209)) (eval!210 (lhs!996 formula!209))) (eval!210 (rhs!997 formula!209))) (ite ((_ is Not!993) formula!209) (not (eval!210 (f!994 formula!209))) (ite ((_ is Variable!998) formula!209) (bvsgt (id!999 formula!209) (_ bv42 32)) error_value!1005)))) (eval!210 (nnf!206 formula!209))))) ))
(check-sat)
(exit)
