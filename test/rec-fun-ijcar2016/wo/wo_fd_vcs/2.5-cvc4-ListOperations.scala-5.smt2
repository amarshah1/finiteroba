...
(assert (exists ((l1!210 List!1006) (l2!211 List!1006)) (not (=> (= (size!206 l1!210) (size!206 l2!211)) (= (iplSize!209 (ite ((_ is Nil!1010) l1!210) IPNil!1016 (ite ((_ is Cons!1007) l1!210) (ite ((_ is Cons!1007) l2!211) (IPCons!1013 (IP!1018 (head!1008 l1!210) (head!1008 l2!211)) (zip!212 (tail!1009 l1!210) (tail!1009 l2!211))) error_value!1024) error_value!1025))) (size!206 l1!210)))) ))
(check-sat)
(exit)
