...
(assert (exists ((x!380 Nat!2033) (t!382 Lst!2037) (l!381 Lst!2037)) (not (or (or (not (mem!270 x!380 t!382)) (not (mem!270 x!380 t!382))) (mem!270 x!380 (append!252 l!381 t!382)))) ))
(check-sat)
(exit)
