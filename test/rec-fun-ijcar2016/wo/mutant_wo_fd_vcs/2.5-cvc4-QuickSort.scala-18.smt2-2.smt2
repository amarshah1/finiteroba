...
(assert (not (forall ((n!234 (_ BitVec 32))) (ite ((_ is Some!1130) (max!216 (smaller!233 n!234 Nil!1127))) error_value!1135 (ite ((_ is None!1129) (max!216 (smaller!233 n!234 Nil!1127))) true (bvslt (i!1131 (max!216 (smaller!233 n!234 Nil!1127))) n!234))) )))
(check-sat)
(exit)
