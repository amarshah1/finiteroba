...
(assert (not (forall ((acc!216 Int) (l!215 List!1044)) (or (not (>= acc!216 0)) (= acc!216 (+ (* (- 1) (size!206 (tail!1047 l!215))) (ite ((_ is Nil!1048) l!215) acc!216 (ite ((_ is Cons!1045) l!215) (sizeTailRecAcc!217 l!215 (+ 1 acc!216)) error_value!1051))))) )))
(check-sat)
(exit)
