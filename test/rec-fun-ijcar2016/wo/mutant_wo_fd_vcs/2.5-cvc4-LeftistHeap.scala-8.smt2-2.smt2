...
(assert (not (forall ((h1!213 Heap!968) (h2!214 Heap!968)) (or (not (hasLeftistProperty!208 h2!214)) (not (hasLeftistProperty!208 h1!213)) (= (size!210 (ite ((_ is Leaf!969) h1!213) h2!214 (right!974 h2!214))) (bvadd (size!210 h1!213) (size!210 h2!214)))) )))
(check-sat)
(exit)
