...
(assert (not (forall ((n!234 (_ BitVec 32)) (BOUND_VARIABLE_396 (_ BitVec 32)) (BOUND_VARIABLE_397 List!1109)) (or (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) (not (bvslt (i!1117 (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) n!234)) (ite ((_ is None!1115) (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) false (not error_value!1121))) (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) (bvslt (i!1117 (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) n!234) (ite ((_ is None!1115) (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) true error_value!1122))) )))
(check-sat)
(exit)
