...
(assert (not (forall ((BOUND_VARIABLE_523 Formula!1304) (BOUND_VARIABLE_524 Formula!1304)) (or (and (= (nnf!210 BOUND_VARIABLE_524) BOUND_VARIABLE_524) (not (isNNF!212 BOUND_VARIABLE_524))) (and (isNNF!212 BOUND_VARIABLE_523) (not (= (nnf!210 BOUND_VARIABLE_523) BOUND_VARIABLE_523))) (not (isNNF!212 (Or!1315 BOUND_VARIABLE_523 BOUND_VARIABLE_524))) (= (nnf!210 (Or!1315 BOUND_VARIABLE_523 BOUND_VARIABLE_524)) (Or!1315 BOUND_VARIABLE_523 BOUND_VARIABLE_524))) )))
(check-sat)
(exit)
