...
(assert (not (forall ((h!211 Heap!937)) (or (hasLeftistProperty!208 h!211) (not (bvslt (size!210 (ite ((_ is Node!939) h!211) (merge!215 (left!942 h!211) (right!943 h!211)) (ite ((_ is Leaf!938) h!211) h!211 error_value!949))) (bvadd (size!210 h!211) (_ bv4294967295 32))))) )))
(check-sat)
(exit)
