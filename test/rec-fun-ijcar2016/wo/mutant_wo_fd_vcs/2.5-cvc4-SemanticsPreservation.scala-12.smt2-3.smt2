...
(assert (not (forall ((BOUND_VARIABLE_505 Formula!1065) (BOUND_VARIABLE_506 Formula!1065)) (or (= (eval!210 BOUND_VARIABLE_506) (not (eval!210 (nnf!206 BOUND_VARIABLE_506)))) (= (eval!210 BOUND_VARIABLE_505) (not (eval!210 (nnf!206 BOUND_VARIABLE_505)))) (= (eval!210 BOUND_VARIABLE_505) (eval!210 (nnf!206 (And!1066 (And!1066 BOUND_VARIABLE_505 BOUND_VARIABLE_506) BOUND_VARIABLE_506))))) )))
(check-sat)
(exit)
