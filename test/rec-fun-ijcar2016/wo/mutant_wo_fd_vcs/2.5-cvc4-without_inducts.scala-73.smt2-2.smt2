...
(assert (not (forall ((x!422 Nat!2151) (xs!423 Lst!2155) (ys!424 Lst!2155)) (= (zip!288 (cons!2156 (head!209 ys!424) xs!423) ys!424) (ite (= ys!424 nil!2159) znil!2164 (zcons!2161 (mkpair!2166 x!422 x!422) (zip!288 xs!423 (tail!211 ys!424))))) )))
(check-sat)
(exit)
