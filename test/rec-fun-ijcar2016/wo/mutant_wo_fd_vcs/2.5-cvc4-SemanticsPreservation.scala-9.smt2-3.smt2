...
(assert (not (forall ((BOUND_VARIABLE_682 Formula!1022) (BOUND_VARIABLE_683 Formula!1022)) (or (= (ite ((_ is And!1023) BOUND_VARIABLE_683) (and (eval!210 (rhs!1025 BOUND_VARIABLE_683)) (eval!210 (lhs!1024 BOUND_VARIABLE_683))) (ite ((_ is Or!1028) BOUND_VARIABLE_683) (or (eval!210 (rhs!1030 BOUND_VARIABLE_683)) (eval!210 (lhs!1029 BOUND_VARIABLE_683))) (ite ((_ is Not!1026) BOUND_VARIABLE_683) (not (eval!210 (f!1027 BOUND_VARIABLE_683))) (ite ((_ is Variable!1031) BOUND_VARIABLE_683) (eval!210 (lhs!1024 BOUND_VARIABLE_682)) error_value!1037)))) (not (eval!210 (nnf!206 BOUND_VARIABLE_683)))) (= (ite ((_ is And!1023) BOUND_VARIABLE_682) (and (eval!210 (rhs!1025 BOUND_VARIABLE_682)) (bvslt (_ bv42 32) (id!1032 BOUND_VARIABLE_683))) (ite ((_ is Or!1028) BOUND_VARIABLE_682) (or (eval!210 (rhs!1030 BOUND_VARIABLE_682)) (eval!210 (lhs!1029 BOUND_VARIABLE_682))) (ite ((_ is Not!1026) BOUND_VARIABLE_682) (not (eval!210 (f!1027 BOUND_VARIABLE_682))) (ite ((_ is Variable!1031) BOUND_VARIABLE_682) (bvslt (_ bv42 32) (id!1032 BOUND_VARIABLE_682)) error_value!1036)))) (not (eval!210 (nnf!206 BOUND_VARIABLE_682)))) (= (or (eval!210 BOUND_VARIABLE_683) (eval!210 BOUND_VARIABLE_682)) (eval!210 (nnf!206 (Or!1028 BOUND_VARIABLE_682 BOUND_VARIABLE_683))))) )))
(check-sat)
(exit)
