...
(assert (not (forall ((BOUND_VARIABLE_484 Formula!1206)) (or (and (isNNF!212 BOUND_VARIABLE_484) (isNNF!212 (Not!1215 BOUND_VARIABLE_484))) (isNNF!212 (simplify!206 BOUND_VARIABLE_484)) (isNNF!212 (simplify!206 (Not!1215 BOUND_VARIABLE_484)))) )))
(check-sat)
(exit)
