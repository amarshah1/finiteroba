...
(assert (not (forall ((t!248 Tree!1262) (e!249 (_ BitVec 32))) (or (not (isAVL!238 t!248)) (and (not (bvslt (bvadd (rank!222 t!248) (_ bv1 32)) (size!224 (balance!252 (unbalancedInsert!247 t!248 e!249))))) (not (bvslt (bvadd (size!224 t!248) (_ bv1 32)) (rank!222 (balance!252 (unbalancedInsert!247 t!248 e!249))))) (not (bvslt (rank!222 (balance!252 (unbalancedInsert!247 t!248 e!249))) (rank!222 t!248))) (isAVL!238 (balance!252 (unbalancedInsert!247 t!248 e!249))))) )))
(check-sat)
(exit)
