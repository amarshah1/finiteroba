...
(assert (not (forall ((n!228 (_ BitVec 32)) (BOUND_VARIABLE_391 (_ BitVec 32)) (BOUND_VARIABLE_392 List!1065)) (or (ite ((_ is Some!1072) (min!214 (greater!227 n!228 (Cons!1066 BOUND_VARIABLE_391 BOUND_VARIABLE_392)))) (not (bvslt n!228 (i!1073 (min!214 (greater!227 n!228 BOUND_VARIABLE_392))))) (ite ((_ is None!1071) (min!214 (greater!227 n!228 BOUND_VARIABLE_392))) false (not error_value!1077))) (ite ((_ is Some!1072) (min!214 (greater!227 n!228 BOUND_VARIABLE_392))) (bvslt n!228 (i!1073 (min!214 (greater!227 n!228 (Cons!1066 BOUND_VARIABLE_391 BOUND_VARIABLE_392))))) (ite ((_ is None!1071) (min!214 (greater!227 n!228 (Cons!1066 BOUND_VARIABLE_391 BOUND_VARIABLE_392)))) true error_value!1078))) )))
(check-sat)
(exit)
