...
(assert (not (forall ((BOUND_VARIABLE_626 Expression!2254) (BOUND_VARIABLE_627 Statement!2232) (BOUND_VARIABLE_628 Statement!2232)) (or (and (isWhileFree!221 BOUND_VARIABLE_628) (not (= (eliminateWhileLoops!213 (IfThenElse!2243 BOUND_VARIABLE_626 BOUND_VARIABLE_627 BOUND_VARIABLE_628)) BOUND_VARIABLE_628))) (and (isWhileFree!221 BOUND_VARIABLE_627) (not (= (eliminateWhileLoops!213 BOUND_VARIABLE_627) BOUND_VARIABLE_627))) (not (isWhileFree!221 (IfThenElse!2243 BOUND_VARIABLE_626 BOUND_VARIABLE_627 BOUND_VARIABLE_628))) (= (eliminateWhileLoops!213 BOUND_VARIABLE_628) (IfThenElse!2243 BOUND_VARIABLE_626 BOUND_VARIABLE_627 BOUND_VARIABLE_628))) )))
(check-sat)
(exit)
