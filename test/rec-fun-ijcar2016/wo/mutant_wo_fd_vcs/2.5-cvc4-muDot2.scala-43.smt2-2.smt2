...
(assert (not (forall ((sdsAB!247 subdecs!7090) (sds12!248 subdecs!7090) (g!241 ctx!7107) (z!242 avar!7113)) (or (not (= (subdecs$ctx!1580 sds12!248) (ctx_cons!7108 g!241 z!242 (typ_bind!7117 z!242 (subdecs$decs1!1582 sdsAB!247))))) (not (subdecs$ok!1586 sds12!248)) (not (= (subdecs$ctx!1580 sdsAB!247) (ctx_cons!7108 g!241 z!242 (typ_bind!7117 z!242 (subdecs$decs1!1582 sdsAB!247))))) (not (subdecs$ok!1586 sdsAB!247)) (and (= (subdecs$ctx!1580 sds12!248) (ctx_cons!7108 g!241 z!242 (typ_bind!7117 z!242 (subdecs$decs2!1584 sdsAB!247)))) (subdecs$ok!1586 sds12!248))) )))
(check-sat)
(exit)
