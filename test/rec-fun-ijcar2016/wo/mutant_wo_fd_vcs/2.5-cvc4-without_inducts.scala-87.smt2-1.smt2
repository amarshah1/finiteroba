...
(assert (not (forall ((n!458 Nat!2324) (xs!459 Lst!2328) (ys!460 Lst!2328)) (= (drop!257 n!458 xs!459) (append!252 (drop!257 n!458 xs!459) (drop!257 (minus!240 n!458 (len!254 (append!252 xs!459 ys!460))) ys!460))) )))
(check-sat)
(exit)
