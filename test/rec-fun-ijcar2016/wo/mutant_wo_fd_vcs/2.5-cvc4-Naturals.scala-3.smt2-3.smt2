...
(assert (not (forall ((BOUND_VARIABLE_287 Nat!910)) (or (not (= (plus!207 BOUND_VARIABLE_287 Zero!913) BOUND_VARIABLE_287)) (= (plus!207 BOUND_VARIABLE_287 Zero!913) (Succ!911 (Succ!911 BOUND_VARIABLE_287)))) )))
(check-sat)
(exit)
