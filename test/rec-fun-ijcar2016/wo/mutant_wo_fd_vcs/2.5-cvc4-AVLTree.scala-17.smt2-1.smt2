...
(assert (not (forall ((t!241 Tree!1170)) (or (not (isBST!232 t!241)) (= (ite ((_ is Leaf!1171) t!241) None!1178 (ite (and ((_ is Leaf!1171) (left!1173 t!241)) ((_ is Node!1172) t!241)) (Some!1179 (value!1174 t!241)) (ite ((_ is Node!1172) t!241) (treeMin!230 t!241) error_value!1186))) (bstMin!242 (left!1173 t!241)))) )))
(check-sat)
(exit)
