...
(assert (not (forall ((total!214 Int)) (or (>= total!214 0) (prop!213 total!214 (_1!901 (rec!222 total!214 total!214 0 0)) (_2!902 (rec!222 total!214 total!214 0 0)) (_3!903 (rec!222 total!214 total!214 0 0)))) )))
(check-sat)
(exit)
