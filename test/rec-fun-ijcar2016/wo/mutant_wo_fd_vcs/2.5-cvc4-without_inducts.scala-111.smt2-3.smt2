...
(assert (not (forall ((n!537 Nat!2595) (xs!538 Lst!2599) (ys!539 Lst!2599)) (= (take!260 (len!254 xs!538) (append!252 xs!538 ys!539)) (append!252 (take!260 n!537 xs!538) (take!260 (minus!240 n!537 n!537) ys!539))) )))
(check-sat)
(exit)
