...
(assert (not (forall ((BOUND_VARIABLE_462 (_ BitVec 32))) (or (not (isNNF!212 (simplify!206 (Literal!1196 BOUND_VARIABLE_462)))) (isNNF!212 (Literal!1196 BOUND_VARIABLE_462))) )))
(check-sat)
(exit)
