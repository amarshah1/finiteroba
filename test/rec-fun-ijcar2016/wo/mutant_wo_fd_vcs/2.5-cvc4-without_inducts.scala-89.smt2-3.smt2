...
(assert (not (forall ((n!466 Nat!2348) (m!467 Nat!2348) (xs!468 Lst!2352)) (= (drop!257 n!466 (take!260 (minus!240 m!467 n!466) xs!468)) (take!260 m!467 (drop!257 n!466 xs!468))) )))
(check-sat)
(exit)
