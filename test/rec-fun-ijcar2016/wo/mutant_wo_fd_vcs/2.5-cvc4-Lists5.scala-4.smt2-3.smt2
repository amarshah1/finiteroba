...
(assert (not (forall ((list!220 List!930) (f!219 (Array T!218 Bool))) (ite (ite ((_ is Nil!934) list!220) (equivalence_lemma!946 f!219 list!220) error_value!981) (and (equivalence_lemma_induct!968 f!219 (t!933 list!220)) (equivalence_lemma!946 f!219 list!220)) ((_ is Cons!931) list!220)) )))
(check-sat)
(exit)
