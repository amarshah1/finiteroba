...
(assert (not (forall ((BOUND_VARIABLE_586 (_ BitVec 32)) (BOUND_VARIABLE_587 (_ BitVec 32))) (or (not (isWhileFree!221 (Print!2315 BOUND_VARIABLE_586 BOUND_VARIABLE_587))) (= (eliminateWhileLoops!213 (Print!2315 BOUND_VARIABLE_586 BOUND_VARIABLE_587)) (Print!2315 BOUND_VARIABLE_587 BOUND_VARIABLE_586))) )))
(check-sat)
(exit)
