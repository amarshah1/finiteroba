...
(assert (not (forall ((l!218 List!1133) (x!217 (_ BitVec 32))) (or (not (storeHasValues!213 (tail!1136 l!218))) (not (contains!216 l!218 x!217)) (isValue!206 (ite ((_ is Cons!1134) l!218) (ite (= (key!1140 (head!1135 l!218)) x!217) (value!1141 (head!1135 l!218)) (find!219 x!217 l!218)) error_value!1167))) )))
(check-sat)
(exit)
