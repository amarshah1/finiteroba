...
(assert (not (forall ((n!243 (_ BitVec 32)) (BOUND_VARIABLE_396 (_ BitVec 32)) (BOUND_VARIABLE_397 List!1192)) (or (ite ((_ is Some!1199) (min!214 (equals!239 n!243 (Cons!1193 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) (not (= (i!1200 (min!214 (equals!239 n!243 BOUND_VARIABLE_397))) n!243)) (ite ((_ is None!1198) (min!214 (equals!239 n!243 BOUND_VARIABLE_397))) false (not error_value!1204))) (ite ((_ is Some!1199) (min!214 (equals!239 n!243 BOUND_VARIABLE_397))) (= (i!1200 (min!214 (equals!239 n!243 (Cons!1193 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) n!243) (ite ((_ is None!1198) (min!214 (equals!239 n!243 (Cons!1193 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) true error_value!1205))) )))
(check-sat)
(exit)
