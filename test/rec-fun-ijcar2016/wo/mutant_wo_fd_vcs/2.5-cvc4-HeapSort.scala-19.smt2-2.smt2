...
(assert (not (forall ((l!228 List!1122)) (bvslt (ite ((_ is Nil!1126) l!228) (_ bv0 32) (ite ((_ is Cons!1123) l!228) (bvadd (listSize!229 (tail!1125 l!228)) (_ bv1 32)) error_value!1128)) (_ bv0 32)) )))
(check-sat)
(exit)
