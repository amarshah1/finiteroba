...
(assert (not (forall ((t!225 Tree!1031)) (not (bvslt (ite ((_ is Leaf!1032) t!225) (_ bv0 32) (ite ((_ is Node!1033) t!225) (ite (bvslt (bvadd (height!226 (right!1036 t!225)) (_ bv1 32)) (height!226 (left!1034 t!225))) (bvadd (height!226 (left!1034 t!225)) (_ bv1 32)) (height!226 (right!1036 t!225))) error_value!1039)) (_ bv0 32))) )))
(check-sat)
(exit)
