...
(assert (not (forall ((BOUND_VARIABLE_433 Formula!1336) (BOUND_VARIABLE_434 Formula!1336)) (or (and (isSimplified!208 BOUND_VARIABLE_434) (not (= (simplify!206 BOUND_VARIABLE_434) BOUND_VARIABLE_434))) (and (isSimplified!208 BOUND_VARIABLE_433) (not (= (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434) BOUND_VARIABLE_433))) (not (isSimplified!208 (simplify!206 BOUND_VARIABLE_433))) (= (simplify!206 (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) )))
(check-sat)
(exit)
