...
(assert (not (forall ((BOUND_VARIABLE_523 Formula!1240) (BOUND_VARIABLE_524 Formula!1240)) (or (and (isNNF!212 BOUND_VARIABLE_524) (not (= (nnf!210 BOUND_VARIABLE_524) BOUND_VARIABLE_524))) (and (isNNF!212 BOUND_VARIABLE_523) (not (= (And!1241 BOUND_VARIABLE_523 BOUND_VARIABLE_524) BOUND_VARIABLE_523))) (not (isNNF!212 (nnf!210 BOUND_VARIABLE_523))) (= (nnf!210 (And!1241 BOUND_VARIABLE_523 BOUND_VARIABLE_524)) (And!1241 BOUND_VARIABLE_523 BOUND_VARIABLE_524))) )))
(check-sat)
(exit)
