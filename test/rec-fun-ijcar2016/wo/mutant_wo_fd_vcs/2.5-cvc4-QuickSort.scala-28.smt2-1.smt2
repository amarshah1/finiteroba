...
(assert (not (forall ((e!247 (_ BitVec 32)) (n!246 (_ BitVec 32))) (or (not (bvslt e!247 n!246)) (contains!209 (smaller!233 n!246 Nil!1242) e!247) (not (contains!209 Nil!1242 e!247))) )))
(check-sat)
(exit)
