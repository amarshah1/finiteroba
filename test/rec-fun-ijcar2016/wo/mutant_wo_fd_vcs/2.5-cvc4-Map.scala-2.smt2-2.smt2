...
(assert (not (forall ((l!209 List!947) (f!210 (Array T!208 T!208))) (= (List$map!963 l!209 f!210) (ite ((_ is Cons!948) l!209) error_value!1000 (ite ((_ is Nil!951) l!209) Nil!951 (Cons!948 (h!949 l!209) (List$map!963 (t!950 l!209) f!210))))) )))
(check-sat)
(exit)
