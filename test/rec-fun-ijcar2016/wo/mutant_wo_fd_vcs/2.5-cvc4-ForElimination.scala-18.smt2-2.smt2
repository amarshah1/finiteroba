...
(assert (not (forall ((BOUND_VARIABLE_644 Statement!2164) (BOUND_VARIABLE_645 Expression!2186) (BOUND_VARIABLE_646 Statement!2164) (BOUND_VARIABLE_647 Statement!2164)) (or (and (isWhileFree!221 BOUND_VARIABLE_647) (not (= (eliminateWhileLoops!213 BOUND_VARIABLE_647) BOUND_VARIABLE_647))) (and (isWhileFree!221 BOUND_VARIABLE_646) (not (= (eliminateWhileLoops!213 BOUND_VARIABLE_646) BOUND_VARIABLE_646))) (and (isWhileFree!221 BOUND_VARIABLE_644) (not (= (eliminateWhileLoops!213 BOUND_VARIABLE_644) BOUND_VARIABLE_644))) (not (isWhileFree!221 (For!2170 BOUND_VARIABLE_644 BOUND_VARIABLE_645 BOUND_VARIABLE_646 BOUND_VARIABLE_647))) (= (eliminateWhileLoops!213 (For!2170 BOUND_VARIABLE_644 BOUND_VARIABLE_645 BOUND_VARIABLE_646 BOUND_VARIABLE_647)) (For!2170 BOUND_VARIABLE_647 BOUND_VARIABLE_645 BOUND_VARIABLE_646 BOUND_VARIABLE_644))) )))
(check-sat)
(exit)
