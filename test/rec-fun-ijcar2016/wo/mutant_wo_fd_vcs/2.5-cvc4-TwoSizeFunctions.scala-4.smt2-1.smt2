...
(assert (not (forall ((acc!210 Int) (l!209 List!894)) (or (>= acc!210 0) (= acc!210 (+ (* (- 1) (size1!206 l!209)) (ite ((_ is Nil!898) l!209) acc!210 (ite ((_ is Cons!895) l!209) (size2acc!211 (tail!897 l!209) (+ 1 acc!210)) error_value!901))))) )))
(check-sat)
(exit)
