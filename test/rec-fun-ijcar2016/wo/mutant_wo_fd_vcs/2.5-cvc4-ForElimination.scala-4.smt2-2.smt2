...
(assert (not (forall ((stat!212 Statement!1217)) (isWhileFree!221 (ite ((_ is Block!1221) stat!212) (Block!1221 (eliminateWhileLoopsList!211 (body!1222 stat!212))) (ite ((_ is IfThenElse!1228) stat!212) (IfThenElse!1228 (expr!1237 stat!212) (eliminateWhileLoops!213 (then!1230 stat!212)) (eliminateWhileLoops!213 (elze!1231 stat!212))) (ite ((_ is While!1236) stat!212) (For!1223 Skip!1235 (expr!1229 stat!212) Skip!1235 (eliminateWhileLoops!213 (body!1238 stat!212))) (ite ((_ is For!1223) stat!212) (For!1223 (eliminateWhileLoops!213 (init!1224 stat!212)) (expr!1225 stat!212) (eliminateWhileLoops!213 (step!1226 stat!212)) (eliminateWhileLoops!213 (body!1227 stat!212))) stat!212))))) )))
(check-sat)
(exit)
