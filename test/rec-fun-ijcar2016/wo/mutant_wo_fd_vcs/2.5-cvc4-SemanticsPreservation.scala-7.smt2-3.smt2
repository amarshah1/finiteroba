...
(assert (not (forall ((BOUND_VARIABLE_682 Formula!989) (BOUND_VARIABLE_683 Formula!989)) (or (= (ite ((_ is And!990) BOUND_VARIABLE_683) (and (eval!210 (rhs!992 BOUND_VARIABLE_683)) (eval!210 (lhs!991 BOUND_VARIABLE_683))) (ite ((_ is Or!995) BOUND_VARIABLE_683) (or (eval!210 (rhs!997 BOUND_VARIABLE_683)) (eval!210 (lhs!996 BOUND_VARIABLE_683))) (ite ((_ is Not!993) BOUND_VARIABLE_683) (not (eval!210 (f!994 BOUND_VARIABLE_683))) (ite ((_ is Variable!998) BOUND_VARIABLE_683) (eval!210 (lhs!991 BOUND_VARIABLE_682)) error_value!1004)))) (not (eval!210 (nnf!206 BOUND_VARIABLE_683)))) (= (ite ((_ is And!990) BOUND_VARIABLE_682) (and (eval!210 (rhs!992 BOUND_VARIABLE_682)) (bvslt (_ bv42 32) (id!999 BOUND_VARIABLE_683))) (ite ((_ is Or!995) BOUND_VARIABLE_682) (or (eval!210 (rhs!997 BOUND_VARIABLE_682)) (eval!210 (lhs!996 BOUND_VARIABLE_682))) (ite ((_ is Not!993) BOUND_VARIABLE_682) (not (eval!210 (f!994 BOUND_VARIABLE_682))) (ite ((_ is Variable!998) BOUND_VARIABLE_682) (bvslt (_ bv42 32) (id!999 BOUND_VARIABLE_682)) error_value!1003)))) (not (eval!210 (nnf!206 BOUND_VARIABLE_682)))) (= (and (eval!210 BOUND_VARIABLE_683) (eval!210 BOUND_VARIABLE_682)) (eval!210 (nnf!206 (And!990 BOUND_VARIABLE_682 BOUND_VARIABLE_683))))) )))
(check-sat)
(exit)
