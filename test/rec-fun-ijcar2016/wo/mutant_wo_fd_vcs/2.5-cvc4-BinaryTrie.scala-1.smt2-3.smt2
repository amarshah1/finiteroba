...
(assert (not (forall ((l!205 IList!903)) (not (bvslt (ite ((_ is Nil!907) (tail!906 l!205)) (_ bv0 32) (ite ((_ is Cons!904) l!205) (bvadd (listSize!206 l!205) (_ bv1 32)) error_value!909)) (_ bv0 32))) )))
(check-sat)
(exit)
