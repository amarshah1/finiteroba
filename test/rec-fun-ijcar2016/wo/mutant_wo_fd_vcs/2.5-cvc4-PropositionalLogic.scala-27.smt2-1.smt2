...
(assert (not (forall ((BOUND_VARIABLE_393 (_ BitVec 32))) (or (isSimplified!208 (Literal!1359 BOUND_VARIABLE_393)) (= (simplify!206 (Literal!1359 BOUND_VARIABLE_393)) (Literal!1359 BOUND_VARIABLE_393))) )))
(check-sat)
(exit)
