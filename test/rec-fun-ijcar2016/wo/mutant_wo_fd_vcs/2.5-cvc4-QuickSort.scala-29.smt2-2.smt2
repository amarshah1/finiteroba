...
(assert (not (forall ((e!251 (_ BitVec 32)) (n!250 (_ BitVec 32)) (BOUND_VARIABLE_369 (_ BitVec 32)) (BOUND_VARIABLE_370 List!1245)) (or (and (not (contains!209 (greater!227 n!250 BOUND_VARIABLE_370) e!251)) (bvslt n!250 e!251) (contains!209 BOUND_VARIABLE_370 e!251)) (contains!209 (greater!227 e!251 (Cons!1246 BOUND_VARIABLE_369 BOUND_VARIABLE_370)) n!250) (not (bvslt n!250 e!251)) (not (contains!209 (Cons!1246 BOUND_VARIABLE_369 BOUND_VARIABLE_370) e!251))) )))
(check-sat)
(exit)
