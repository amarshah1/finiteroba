...
(assert (not (forall ((BOUND_VARIABLE_433 Formula!1384) (BOUND_VARIABLE_434 Formula!1384)) (or (and (isSimplified!208 BOUND_VARIABLE_434) (not (= (simplify!206 BOUND_VARIABLE_434) BOUND_VARIABLE_434))) (and (isSimplified!208 BOUND_VARIABLE_433) (not (= (Or!1395 BOUND_VARIABLE_433 BOUND_VARIABLE_434) BOUND_VARIABLE_433))) (not (isSimplified!208 (simplify!206 BOUND_VARIABLE_433))) (= (simplify!206 (Or!1395 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (Or!1395 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) )))
(check-sat)
(exit)
