...
(assert (not (forall ((node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32)) (BOUND_VARIABLE_351 (_ BitVec 32)) (BOUND_VARIABLE_352 (_ BitVec 32)) (BOUND_VARIABLE_353 SortedNDList!896)) (or (and (not (bvslt dist!209 (_ bv0 32))) (not (bvslt node!208 (_ bv0 32))) (sndInvariant!206 BOUND_VARIABLE_353) (not (sndInvariant!206 (ListNode!898 node!208 dist!209 BOUND_VARIABLE_353)))) (bvslt dist!209 (_ bv0 32)) (bvslt node!208 (_ bv0 32)) (not (sndInvariant!206 (ListNode!898 BOUND_VARIABLE_351 BOUND_VARIABLE_352 BOUND_VARIABLE_353))) (sndInvariant!206 (ListNode!898 node!208 BOUND_VARIABLE_351 (ListNode!898 dist!209 BOUND_VARIABLE_352 BOUND_VARIABLE_353)))) )))
(check-sat)
(exit)
