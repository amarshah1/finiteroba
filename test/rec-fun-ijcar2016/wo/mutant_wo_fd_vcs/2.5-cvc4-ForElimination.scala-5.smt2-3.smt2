...
(assert (not (forall ((l!214 List!1285)) (isForFreeList!223 (ite ((_ is Nil!1289) l!214) Nil!1289 (ite ((_ is Cons!1286) l!214) (Cons!1286 (eliminateForLoops!217 (head!1287 l!214)) (tail!1288 l!214)) error_value!1353))) )))
(check-sat)
(exit)
