...
(assert (not (forall ((n!243 (_ BitVec 32))) (ite ((_ is None!1212) (min!214 (equals!239 n!243 Nil!1210))) (= (i!1214 (min!214 (equals!239 n!243 Nil!1210))) n!243) (ite ((_ is Some!1213) (min!214 (equals!239 n!243 Nil!1210))) true error_value!1218)) )))
(check-sat)
(exit)
