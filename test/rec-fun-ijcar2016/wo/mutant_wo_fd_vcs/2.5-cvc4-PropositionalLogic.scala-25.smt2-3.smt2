...
(assert (not (forall ((BOUND_VARIABLE_433 Formula!1320) (BOUND_VARIABLE_434 Formula!1320)) (or (and (isSimplified!208 BOUND_VARIABLE_434) (not (= (simplify!206 BOUND_VARIABLE_434) BOUND_VARIABLE_434))) (and (isSimplified!208 BOUND_VARIABLE_433) (not (= (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434) BOUND_VARIABLE_433))) (not (isSimplified!208 (simplify!206 BOUND_VARIABLE_433))) (= (simplify!206 (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) )))
(check-sat)
(exit)
