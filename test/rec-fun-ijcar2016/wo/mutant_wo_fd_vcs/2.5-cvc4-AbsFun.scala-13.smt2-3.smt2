...
(assert (not (forall ((t!217 array!977) (k!218 (_ BitVec 32))) (or (bvslt (size!979 t!217) (_ bv0 32)) (bvslt k!218 (_ bv0 32)) (not (isPositive!206 t!217 k!218)) (ite (bvslt k!218 (size!979 t!217)) (isPositive!206 (ite (bvslt (ite (and (bvslt k!218 (size!979 t!217)) (not (bvslt k!218 (_ bv0 32)))) (bvneg (ite (and (bvslt k!218 (size!979 t!217)) (not (bvslt k!218 (_ bv0 32)))) (select (content!980 t!217) k!218) error_value!983)) error_value!982) (_ bv0 32)) (ite (and (bvslt k!218 (size!979 t!217)) (not (bvslt k!218 (_ bv0 32)))) (array!977!978 (size!979 t!217) (content!980 t!217)) error_value!984) (ite (and (bvslt k!218 (size!979 t!217)) (not (bvslt k!218 (_ bv0 32)))) (array!977!978 (size!979 t!217) (store (content!980 t!217) k!218 (ite (and (bvslt k!218 (size!979 t!217)) (not (bvslt k!218 (_ bv0 32)))) (select (content!980 t!217) k!218) error_value!985))) error_value!986)) (bvadd k!218 (_ bv1 32))) true)) )))
(check-sat)
(exit)
