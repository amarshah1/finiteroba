...
(assert (not (forall ((n!240 (_ BitVec 32)) (x!239 (_ BitVec 32))) (or (not (bvslt n!240 (_ bv32 32))) (bvslt n!240 (_ bv0 32)) (isRotationLeft!238 (bvadd (bvneg n!240) (_ bv32 32)) (bvor (bvshl x!239 n!240) (bvlshr x!239 x!239)) n!240 (_ bv0 32))) )))
(check-sat)
(exit)
