...
(assert (not (forall ((x!245 (_ BitVec 32)) (y!246 (_ BitVec 32))) (= (bvadd (concat ((_ extract 30 0) (bvand x!245 y!246)) (_ bv0 1)) (concat ((_ extract 31 1) (bvxor x!245 y!246)) (_ bv0 1))) (safeMean!244 x!245 y!246)) )))
(check-sat)
(exit)
