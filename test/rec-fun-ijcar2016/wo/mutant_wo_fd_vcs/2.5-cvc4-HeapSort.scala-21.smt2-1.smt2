...
(assert (not (forall ((h!230 Heap!1134) (l!231 List!1141)) (or (not (hasLeftistProperty!210 h!230)) (= (bvadd (heapSize!212 h!230) (listSize!229 (ite ((_ is Leaf!1135) h!230) l!231 (removeElements!232 (removeMax!226 h!230) (Cons!1142 (findMax!224 h!230) l!231))))) (listSize!229 l!231))) )))
(check-sat)
(exit)
