...
(assert (not (forall ((e!251 (_ BitVec 32)) (n!250 (_ BitVec 32))) (or (not (bvslt n!250 e!251)) (contains!209 (greater!227 n!250 Nil!1256) e!251) (not (contains!209 Nil!1256 e!251))) )))
(check-sat)
(exit)
