...
(assert (not (forall ((BOUND_VARIABLE_502 Formula!1155) (BOUND_VARIABLE_503 Formula!1155)) (or (and (isNNF!212 BOUND_VARIABLE_503) (not (isNNF!212 (simplify!206 BOUND_VARIABLE_503)))) (and (isNNF!212 (And!1156 BOUND_VARIABLE_502 BOUND_VARIABLE_503)) (not (isNNF!212 (simplify!206 BOUND_VARIABLE_502)))) (not (isNNF!212 BOUND_VARIABLE_502)) (isNNF!212 (simplify!206 (And!1156 BOUND_VARIABLE_502 BOUND_VARIABLE_503)))) )))
(check-sat)
(exit)
