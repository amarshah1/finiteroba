...
(assert (not (forall ((l1!207 TokenList!969) (l2!208 TokenList!969)) (= (size!206 (Cons!970 (head!971 l1!207) (append!209 (tail!972 l1!207) l2!208))) (bvadd (size!206 l1!207) (size!206 l2!208))) )))
(check-sat)
(exit)
