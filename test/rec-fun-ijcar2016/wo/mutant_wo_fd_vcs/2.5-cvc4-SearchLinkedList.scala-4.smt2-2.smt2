...
(assert (not (forall ((list!210 List!909)) (and (ite (contains!209 list!210 (_ bv0 32)) (firstZeroAtPos!214 list!210 (ite ((_ is Nil!913) list!210) 0 (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) 0 (+ 1 (firstZero!211 (tail!912 list!210)))) error_value!918))) (= (size!206 list!210) (ite ((_ is Nil!913) list!210) 0 (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) 0 (+ 1 (firstZero!211 (tail!912 list!210)))) error_value!918)))) (>= (ite ((_ is Nil!913) (tail!912 list!210)) 0 (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) 0 (+ 1 (firstZero!211 list!210))) error_value!918)) 0)) )))
(check-sat)
(exit)
