...
(assert (not (forall ((list!208 List!880) (f!207 (Array (_ BitVec 32) (_ BitVec 32)))) (positive!206 (ite ((_ is Cons!881) list!208) (Cons!881 (head!882 list!208) (positiveMap_failling_1!209 f!207 (tail!883 list!208))) (ite ((_ is Nil!884) list!208) Nil!884 error_value!887))) )))
(check-sat)
(exit)
