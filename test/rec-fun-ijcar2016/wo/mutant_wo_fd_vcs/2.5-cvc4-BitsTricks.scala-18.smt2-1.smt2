...
(assert (not (forall ((n!240 (_ BitVec 32)) (x!239 (_ BitVec 32))) (or (not (isRotationLeft!238 x!239 (bvor (bvshl x!239 n!240) (bvlshr x!239 (bvadd (bvneg n!240) (_ bv32 32)))) n!240 (_ bv0 32))) (bvslt n!240 (_ bv0 32)) (bvslt n!240 (_ bv32 32))) )))
(check-sat)
(exit)
