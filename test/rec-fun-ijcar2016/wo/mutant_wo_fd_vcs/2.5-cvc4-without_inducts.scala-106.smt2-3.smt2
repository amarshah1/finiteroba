...
(assert (not (forall ((n!520 Nat!2543) (h!521 Nat!2543) (x!522 Lst!2547)) (or (= (count!263 n!520 x!522) (count!263 n!520 (append!252 x!522 (cons!2548 h!521 nil!2551)))) (= n!520 h!521)) )))
(check-sat)
(exit)
