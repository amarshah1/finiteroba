...
(assert (not (forall ((n!412 Nat!2120) (h!413 Nat!2120) (t!414 Lst!2124)) (= (plus!237 (count!263 n!412 (cons!2125 h!413 t!414)) (count!263 n!412 t!414)) (count!263 n!412 (cons!2125 h!413 nil!2128))) )))
(check-sat)
(exit)
