...
(assert (not (forall ((BOUND_VARIABLE_415 Formula!1368)) (or (and (= (simplify!206 BOUND_VARIABLE_415) BOUND_VARIABLE_415) (not (isSimplified!208 BOUND_VARIABLE_415))) (not (isSimplified!208 (Not!1377 BOUND_VARIABLE_415))) (= (simplify!206 (Not!1377 BOUND_VARIABLE_415)) (Not!1377 BOUND_VARIABLE_415))) )))
(check-sat)
(exit)
