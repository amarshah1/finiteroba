...
(assert (not (forall ((BOUND_VARIABLE_732 Expression!1850) (BOUND_VARIABLE_733 Statement!1828)) (or ((_ is While!1847) BOUND_VARIABLE_733) (isForFree!225 (While!1847 BOUND_VARIABLE_732 (eliminateForLoops!217 BOUND_VARIABLE_733)))) )))
(check-sat)
(exit)
