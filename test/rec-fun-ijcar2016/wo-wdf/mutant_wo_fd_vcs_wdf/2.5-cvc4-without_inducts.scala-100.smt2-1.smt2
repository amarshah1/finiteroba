...
(assert (not (forall ((n!500 Nat!2478) (m!501 Nat!2478)) (or (leq!234 n!500 (plus!237 n!500 m!501)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) n!500) (= (leq!234_arg_1_2 ?z) (plus!237 n!500 m!501)))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_5 ?z) n!500) (= (plus!237_arg_1_6 ?z) m!501))) )) )))
(check-sat)
(exit)
