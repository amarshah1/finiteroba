...
(assert (not (forall ((n!311 Nat!1855) (l!312 Lst!1859) (m!313 Lst!1859)) (or (leq!234 n!311 (count!263 (count!263 n!311 l!312) (append!252 l!312 m!313))) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) n!311) (= (leq!234_arg_1_2 ?z) (count!263 (count!263 n!311 l!312) (append!252 l!312 m!313))))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_5 ?z) (count!263 n!311 l!312)) (= (count!263_arg_1_6 ?z) (append!252 l!312 m!313)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_5 ?z) n!311) (= (count!263_arg_1_6 ?z) l!312))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_7 ?z) l!312) (= (append!252_arg_1_8 ?z) m!313))) )) )))
(check-sat)
(exit)
