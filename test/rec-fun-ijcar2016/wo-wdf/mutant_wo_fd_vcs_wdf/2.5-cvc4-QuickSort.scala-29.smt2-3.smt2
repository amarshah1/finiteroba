...
(assert (not (forall ((e!251 (_ BitVec 32)) (n!250 (_ BitVec 32)) (BOUND_VARIABLE_369 (_ BitVec 32)) (BOUND_VARIABLE_370 List!1245)) (or (and (not (and (contains!209 (greater!227 n!250 BOUND_VARIABLE_370) e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (greater!227 n!250 BOUND_VARIABLE_370)) (= (contains!209_arg_1_2 ?z) e!251))) )) (not (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_3 ?z) n!250) (= (greater!227_arg_1_4 ?z) BOUND_VARIABLE_370))) )))) (bvslt n!250 e!251) (or (contains!209 BOUND_VARIABLE_370 e!251) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) BOUND_VARIABLE_370) (= (contains!209_arg_1_2 ?z) e!251))) ))) (or (contains!209 (greater!227 n!250 (Cons!1246 e!251 BOUND_VARIABLE_370)) e!251) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (greater!227 n!250 (Cons!1246 e!251 BOUND_VARIABLE_370))) (= (contains!209_arg_1_2 ?z) e!251))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_3 ?z) n!250) (= (greater!227_arg_1_4 ?z) (Cons!1246 e!251 BOUND_VARIABLE_370)))) )) (not (bvslt n!250 BOUND_VARIABLE_369)) (not (and (contains!209 (Cons!1246 BOUND_VARIABLE_369 BOUND_VARIABLE_370) e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (Cons!1246 BOUND_VARIABLE_369 BOUND_VARIABLE_370)) (= (contains!209_arg_1_2 ?z) e!251))) ))))) )))
(check-sat)
(exit)
