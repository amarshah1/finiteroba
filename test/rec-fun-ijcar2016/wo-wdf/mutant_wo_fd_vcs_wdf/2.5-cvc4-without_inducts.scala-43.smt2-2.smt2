...
(assert (not (forall ((k!328 Nat!1901) (m!330 Nat!1901) (n!329 Nat!1901)) (or (= (minus!240 (plus!237 k!328 m!330) n!329) (minus!240 m!330 (plus!237 k!328 n!329))) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (plus!237 k!328 m!330)) (= (minus!240_arg_1_2 ?z) n!329))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) k!328) (= (plus!237_arg_1_4 ?z) m!330))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) m!330) (= (minus!240_arg_1_2 ?z) (plus!237 k!328 n!329)))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) k!328) (= (plus!237_arg_1_4 ?z) n!329))) )) )))
(check-sat)
(exit)
