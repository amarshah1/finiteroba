...
(assert (not (forall ((inp!213 IList!981)) (not (and (bvslt (listSize!206 inp!213) (height!209 (insert!212 inp!213 Leaf!987))) (not (forall ((?z I_listSize!206)) (not (= (listSize!206_arg_0_4 ?z) inp!213)) )) (not (forall ((?z I_height!209)) (not (= (height!209_arg_0_1 ?z) (insert!212 inp!213 Leaf!987))) )) (not (forall ((?z I_insert!212)) (not (and (= (insert!212_arg_0_2 ?z) inp!213) (= (insert!212_arg_1_3 ?z) Leaf!987))) )))) )))
(check-sat)
(exit)
