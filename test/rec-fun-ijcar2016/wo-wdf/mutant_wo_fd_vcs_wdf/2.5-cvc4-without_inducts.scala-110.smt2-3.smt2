...
(assert (not (forall ((m!533 Nat!2590) (n!534 Nat!2590) (k!535 Nat!2590)) (or (= (minus!240 (minus!240 (succ!2591 (minus!240 m!533 n!534)) n!534) (succ!2591 k!535)) (minus!240 m!533 k!535)) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (minus!240 (succ!2591 (minus!240 m!533 n!534)) n!534)) (= (minus!240_arg_1_2 ?z) (succ!2591 k!535)))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (succ!2591 (minus!240 m!533 n!534))) (= (minus!240_arg_1_2 ?z) n!534))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) m!533) (= (minus!240_arg_1_2 ?z) n!534))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) m!533) (= (minus!240_arg_1_2 ?z) k!535))) )) )))
(check-sat)
(exit)
