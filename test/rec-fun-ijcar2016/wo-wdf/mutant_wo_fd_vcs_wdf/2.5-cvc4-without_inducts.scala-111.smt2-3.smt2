...
(assert (not (forall ((n!537 Nat!2595) (xs!538 Lst!2599) (ys!539 Lst!2599)) (or (= (take!260 (len!254 xs!538) (append!252 xs!538 ys!539)) (append!252 (take!260 n!537 xs!538) (take!260 (minus!240 n!537 n!537) ys!539))) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) (len!254 xs!538)) (= (take!260_arg_1_2 ?z) (append!252 xs!538 ys!539)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_7 ?z) xs!538)) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) xs!538) (= (append!252_arg_1_4 ?z) ys!539))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) (take!260 n!537 xs!538)) (= (append!252_arg_1_4 ?z) (take!260 (minus!240 n!537 n!537) ys!539)))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) n!537) (= (take!260_arg_1_2 ?z) xs!538))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) (minus!240 n!537 n!537)) (= (take!260_arg_1_2 ?z) ys!539))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_5 ?z) n!537) (= (minus!240_arg_1_6 ?z) n!537))) )) )))
(check-sat)
(exit)
