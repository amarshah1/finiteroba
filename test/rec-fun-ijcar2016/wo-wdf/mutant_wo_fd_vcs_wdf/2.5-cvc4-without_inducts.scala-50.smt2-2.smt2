...
(assert (not (forall ((n!350 Nat!1960)) (or (= (= n!350 zero!1963) (leq!234 n!350 zero!1963)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) n!350) (= (leq!234_arg_1_2 ?z) zero!1963))) )) )))
(check-sat)
(exit)
