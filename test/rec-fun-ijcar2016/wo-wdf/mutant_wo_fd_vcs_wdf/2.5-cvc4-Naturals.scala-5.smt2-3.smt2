...
(assert (not (forall ((y!213 Nat!920) (z!214 Nat!920) (BOUND_VARIABLE_295 Nat!920)) (or (not (and (= (plus!207 (Succ!921 BOUND_VARIABLE_295) y!213) (plus!207 (plus!207 BOUND_VARIABLE_295 y!213) z!214)) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!921 BOUND_VARIABLE_295)) (= (plus!207_arg_1_2 ?z) y!213))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (plus!207 BOUND_VARIABLE_295 y!213)) (= (plus!207_arg_1_2 ?z) z!214))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) BOUND_VARIABLE_295) (= (plus!207_arg_1_2 ?z) y!213))) )))) (or (= (plus!207 (Succ!921 BOUND_VARIABLE_295) (plus!207 y!213 z!214)) (plus!207 (plus!207 BOUND_VARIABLE_295 (plus!207 y!213 z!214)) z!214)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!921 BOUND_VARIABLE_295)) (= (plus!207_arg_1_2 ?z) (plus!207 y!213 z!214)))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!213) (= (plus!207_arg_1_2 ?z) z!214))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (plus!207 BOUND_VARIABLE_295 (plus!207 y!213 z!214))) (= (plus!207_arg_1_2 ?z) z!214))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) BOUND_VARIABLE_295) (= (plus!207_arg_1_2 ?z) (plus!207 y!213 z!214)))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!213) (= (plus!207_arg_1_2 ?z) z!214))) ))) )))
(check-sat)
(exit)
