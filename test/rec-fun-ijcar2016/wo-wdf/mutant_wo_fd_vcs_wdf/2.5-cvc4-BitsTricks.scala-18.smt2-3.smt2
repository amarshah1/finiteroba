...
(assert (not (forall ((n!240 (_ BitVec 32)) (x!239 (_ BitVec 32))) (or (isRotationLeft!238 x!239 (bvor (bvshl x!239 n!240) (bvlshr x!239 (bvadd (bvneg n!240) (_ bv32 32)))) n!240 (_ bv0 32)) (forall ((?z I_isRotationLeft!238)) (not (and (= (isRotationLeft!238_arg_0_1 ?z) x!239) (= (isRotationLeft!238_arg_1_2 ?z) (bvor (bvshl x!239 n!240) (bvlshr x!239 (bvadd (bvneg n!240) (_ bv32 32))))) (= (isRotationLeft!238_arg_2_3 ?z) n!240) (= (isRotationLeft!238_arg_3_4 ?z) (_ bv0 32)))) )) )))
(check-sat)
(exit)
