...
(assert (not (forall ((BOUND_VARIABLE_290 Nat!930)) (or (not (and (= (plus!207 Zero!933 BOUND_VARIABLE_290) (plus!207 (Succ!931 BOUND_VARIABLE_290) Zero!933)) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) Zero!933) (= (plus!207_arg_1_2 ?z) BOUND_VARIABLE_290))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!931 BOUND_VARIABLE_290)) (= (plus!207_arg_1_2 ?z) Zero!933))) )))) (or (= (plus!207 Zero!933 (Succ!931 BOUND_VARIABLE_290)) (plus!207 BOUND_VARIABLE_290 Zero!933)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) Zero!933) (= (plus!207_arg_1_2 ?z) (Succ!931 BOUND_VARIABLE_290)))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) BOUND_VARIABLE_290) (= (plus!207_arg_1_2 ?z) Zero!933))) ))) )))
(check-sat)
(exit)
