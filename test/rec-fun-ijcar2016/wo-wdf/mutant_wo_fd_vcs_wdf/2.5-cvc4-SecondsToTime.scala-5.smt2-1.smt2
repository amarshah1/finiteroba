...
(assert (not (forall ((total!218 Int) (h!220 Int) (m!221 Int) (r!219 Int)) (or (>= m!221 0) (>= m!221 60) (not (>= r!219 0)) (not (>= h!220 0)) (not (>= (+ (* 60 m!221) r!219) 3600)) (= m!221 0) (not (and (propSum!208 total!218 h!220 m!221 r!219) (not (forall ((?z I_propSum!208)) (not (and (= (propSum!208_arg_0_1 ?z) total!218) (= (propSum!208_arg_1_2 ?z) h!220) (= (propSum!208_arg_2_3 ?z) m!221) (= (propSum!208_arg_3_4 ?z) r!219))) )))) (or (prop!213 total!218 (_1!911 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219)))) (_2!912 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219)))) (_3!913 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219))))) (forall ((?z I_prop!213)) (not (and (= (prop!213_arg_0_9 ?z) total!218) (= (prop!213_arg_1_10 ?z) (_1!911 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219))))) (= (prop!213_arg_2_11 ?z) (_2!912 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219))))) (= (prop!213_arg_3_12 ?z) (_3!913 (ite (>= r!219 3600) (rec!222 total!218 (+ (- 3600) r!219) (+ 1 h!220) m!221) (ite (>= r!219 60) (rec!222 total!218 (+ (- 60) r!219) h!220 (+ 1 m!221)) (tuple3!909!910 h!220 m!221 r!219))))))) ) (not (ite (>= r!219 3600) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 3600) r!219)) (= (rec!222_arg_2_7 ?z) (+ 1 h!220)) (= (rec!222_arg_3_8 ?z) m!221))) )) (ite (>= r!219 60) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 60) r!219)) (= (rec!222_arg_2_7 ?z) h!220) (= (rec!222_arg_3_8 ?z) (+ 1 m!221)))) )) true))) (not (ite (>= r!219 3600) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 3600) r!219)) (= (rec!222_arg_2_7 ?z) (+ 1 h!220)) (= (rec!222_arg_3_8 ?z) m!221))) )) (ite (>= r!219 60) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 60) r!219)) (= (rec!222_arg_2_7 ?z) h!220) (= (rec!222_arg_3_8 ?z) (+ 1 m!221)))) )) true))) (not (ite (>= r!219 3600) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 3600) r!219)) (= (rec!222_arg_2_7 ?z) (+ 1 h!220)) (= (rec!222_arg_3_8 ?z) m!221))) )) (ite (>= r!219 60) (not (forall ((?z I_rec!222)) (not (and (= (rec!222_arg_0_5 ?z) total!218) (= (rec!222_arg_1_6 ?z) (+ (- 60) r!219)) (= (rec!222_arg_2_7 ?z) h!220) (= (rec!222_arg_3_8 ?z) (+ 1 m!221)))) )) true))))) )))
(check-sat)
(exit)
