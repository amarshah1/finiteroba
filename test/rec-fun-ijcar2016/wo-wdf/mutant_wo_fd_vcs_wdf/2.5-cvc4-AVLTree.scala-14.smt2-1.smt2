...
(assert (not (forall ((t!239 Tree!1121)) (or (not (and (isBST!232 t!239) (not (forall ((?z I_isBST!232)) (not (= (isBST!232_arg_0_10 ?z) t!239)) )))) (or (= (ite ((_ is Leaf!1122) t!239) None!1129 (ite (and ((_ is Leaf!1122) (right!1126 t!239)) ((_ is Node!1123) t!239)) (Some!1130 (value!1125 t!239)) (ite ((_ is Node!1123) t!239) (treeMax!228 t!239) error_value!1137))) (bstMax!240 (right!1126 t!239))) (not (ite ((_ is Leaf!1122) t!239) true (ite (and ((_ is Leaf!1122) (right!1126 t!239)) ((_ is Node!1123) t!239)) true (ite ((_ is Node!1123) t!239) (not (forall ((?z I_treeMax!228)) (not (= (treeMax!228_arg_0_5 ?z) t!239)) )) true)))) (forall ((?z I_bstMax!240)) (not (= (bstMax!240_arg_0_1 ?z) (right!1126 t!239))) ))) )))
(check-sat)
(exit)
