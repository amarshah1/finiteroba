...
(assert (not (forall ((y!213 Nat!925) (z!214 Nat!925)) (or (= (plus!207 Zero!928 (plus!207 Zero!928 y!213)) (plus!207 (plus!207 y!213 z!214) z!214)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) Zero!928) (= (plus!207_arg_1_2 ?z) (plus!207 Zero!928 y!213)))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) Zero!928) (= (plus!207_arg_1_2 ?z) y!213))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (plus!207 y!213 z!214)) (= (plus!207_arg_1_2 ?z) z!214))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!213) (= (plus!207_arg_1_2 ?z) z!214))) )) )))
(check-sat)
(exit)
