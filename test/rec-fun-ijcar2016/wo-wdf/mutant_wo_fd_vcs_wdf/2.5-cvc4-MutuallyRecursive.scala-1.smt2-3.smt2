...
(assert (not (forall ((n!206 (_ BitVec 32))) (or (= (fib!209 (bvadd n!206 (_ bv4294967295 32))) (ite (not (bvslt (_ bv0 32) n!206)) (_ bv1 32) (f!205 (bvadd n!206 (_ bv1 32))))) (forall ((?z I_fib!209)) (not (= (fib!209_arg_0_3 ?z) (bvadd n!206 (_ bv4294967295 32)))) ) (not (ite (not (bvslt (_ bv0 32) n!206)) true (not (forall ((?z I_f!205)) (not (= (f!205_arg_0_1 ?z) (bvadd n!206 (_ bv1 32)))) ))))) )))
(check-sat)
(exit)
