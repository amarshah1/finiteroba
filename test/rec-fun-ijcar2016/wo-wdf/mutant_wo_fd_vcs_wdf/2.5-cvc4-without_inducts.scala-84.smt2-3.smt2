...
(assert (not (forall ((x!448 Nat!2300) (l!449 Lst!2304)) (or (= (count!263 (count!263 x!448 (sort!285 l!449)) l!449) x!448) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) (count!263 x!448 (sort!285 l!449))) (= (count!263_arg_1_2 ?z) l!449))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) x!448) (= (count!263_arg_1_2 ?z) (sort!285 l!449)))) ) (forall ((?z I_sort!285)) (not (= (sort!285_arg_0_3 ?z) l!449)) )) )))
(check-sat)
(exit)
