...
(assert (not (forall ((BOUND_VARIABLE_505 Formula!1093) (BOUND_VARIABLE_506 Formula!1093)) (or (or (eval!210 BOUND_VARIABLE_506) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) BOUND_VARIABLE_506)) )) (or (= (eval!210 BOUND_VARIABLE_505) (not (eval!210 (nnf!206 BOUND_VARIABLE_505)))) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) BOUND_VARIABLE_505)) ) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (nnf!206 BOUND_VARIABLE_505))) ) (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) BOUND_VARIABLE_505)) )) (or (= (eval!210 (Or!1099 BOUND_VARIABLE_505 BOUND_VARIABLE_506)) (eval!210 (nnf!206 (Or!1099 BOUND_VARIABLE_505 BOUND_VARIABLE_506)))) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (Or!1099 BOUND_VARIABLE_505 BOUND_VARIABLE_506))) ) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (nnf!206 (Or!1099 BOUND_VARIABLE_505 BOUND_VARIABLE_506)))) ) (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Or!1099 BOUND_VARIABLE_505 BOUND_VARIABLE_506))) ))) )))
(check-sat)
(exit)
