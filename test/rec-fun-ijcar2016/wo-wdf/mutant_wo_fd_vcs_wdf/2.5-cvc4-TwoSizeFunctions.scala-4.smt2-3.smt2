...
(assert (not (forall ((acc!210 Int) (l!209 List!894)) (or (not (>= acc!210 0)) (or (= acc!210 (+ (* (- 1) (size1!206 l!209)) (ite ((_ is Nil!898) l!209) acc!210 (ite ((_ is Cons!895) (tail!897 l!209)) (size2acc!211 l!209 (+ 1 acc!210)) error_value!901)))) (forall ((?z I_size1!206)) (not (= (size1!206_arg_0_3 ?z) l!209)) ) (not (ite ((_ is Nil!898) l!209) true (ite ((_ is Cons!895) (tail!897 l!209)) (not (forall ((?z I_size2acc!211)) (not (and (= (size2acc!211_arg_0_1 ?z) l!209) (= (size2acc!211_arg_1_2 ?z) (+ 1 acc!210)))) )) true))))) )))
(check-sat)
(exit)
