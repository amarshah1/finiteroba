...
(assert (not (forall ((xs!435 Lst!2241)) (or (or (= (butlast!267 (append!252 xs!435 xs!435)) (cons!2242 (last!265 xs!435) nil!2245)) (forall ((?z I_butlast!267)) (not (= (butlast!267_arg_0_1 ?z) (append!252 xs!435 xs!435))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!435) (= (append!252_arg_1_3 ?z) xs!435))) ) (forall ((?z I_last!265)) (not (= (last!265_arg_0_4 ?z) xs!435)) )) (= xs!435 nil!2245)) )))
(check-sat)
(exit)
