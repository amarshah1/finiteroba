...
(assert (not (forall ((ys!478 Lst!2392) (xs!477 Lst!2392)) (or (= ys!478 nil!2396) (or (= (last!265 (append!252 xs!477 ys!478)) (last!265 ys!478)) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) (append!252 xs!477 ys!478))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!477) (= (append!252_arg_1_3 ?z) ys!478))) ) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) ys!478)) ))) )))
(check-sat)
(exit)
