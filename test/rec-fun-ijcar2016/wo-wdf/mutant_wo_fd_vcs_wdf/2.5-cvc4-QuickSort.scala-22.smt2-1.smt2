...
(assert (not (forall ((n!240 (_ BitVec 32))) (or (ite ((_ is Some!1174) (max!216 (equals!239 (i!1175 (max!216 (equals!239 n!240 Nil!1171))) Nil!1171))) true (or (ite ((_ is None!1173) (max!216 (equals!239 n!240 Nil!1171))) true error_value!1179) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 Nil!1171))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) Nil!1171))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 (i!1175 (max!216 (equals!239 n!240 Nil!1171))) Nil!1171))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) (i!1175 (max!216 (equals!239 n!240 Nil!1171)))) (= (equals!239_arg_1_3 ?z) Nil!1171))) ) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 Nil!1171))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) Nil!1171))) )) )))
(check-sat)
(exit)
