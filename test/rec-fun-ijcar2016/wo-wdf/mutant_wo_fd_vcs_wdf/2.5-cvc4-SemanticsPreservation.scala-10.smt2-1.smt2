...
(assert (not (forall ((BOUND_VARIABLE_523 (_ BitVec 32))) (or (= (eval!210 (nnf!206 (Variable!1048 BOUND_VARIABLE_523))) (bvslt (_ bv42 32) BOUND_VARIABLE_523)) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (nnf!206 (Variable!1048 BOUND_VARIABLE_523)))) ) (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Variable!1048 BOUND_VARIABLE_523))) )) )))
(check-sat)
(exit)
