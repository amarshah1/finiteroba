...
(assert (not (forall ((n!220 (_ BitVec 32)) (x!219 (_ BitVec 32))) (or (not (bvslt n!220 (_ bv32 32))) (bvslt n!220 (_ bv0 32)) (not (and (= (isBitNSet!213 x!219 n!220) (_ bv0 32)) (not (forall ((?z I_isBitNSet!213)) (not (and (= (isBitNSet!213_arg_0_1 ?z) x!219) (= (isBitNSet!213_arg_1_2 ?z) n!220))) ))))) )))
(check-sat)
(exit)
