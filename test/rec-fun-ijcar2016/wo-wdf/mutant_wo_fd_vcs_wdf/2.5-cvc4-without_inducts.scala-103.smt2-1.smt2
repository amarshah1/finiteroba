...
(assert (not (forall ((x!510 Nat!2501) (y!511 Nat!2501) (l!512 Lst!2505)) (or (or (mem!270 x!510 (insort!281 y!511 l!512)) (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!510) (= (mem!270_arg_1_2 ?z) (insort!281 y!511 l!512)))) ) (forall ((?z I_insort!281)) (not (and (= (insort!281_arg_0_3 ?z) y!511) (= (insort!281_arg_1_4 ?z) l!512))) )) (= x!510 y!511)) )))
(check-sat)
(exit)
