...
(assert (not (forall ((x!497 Nat!2466) (l!498 Lst!2470)) (or (leq!234 x!497 (len!254 l!498)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) x!497) (= (leq!234_arg_1_2 ?z) (len!254 l!498)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_5 ?z) l!498)) )) )))
(check-sat)
(exit)
