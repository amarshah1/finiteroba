...
(assert (not (forall ((acc!216 Int) (l!215 List!1044)) (or (not (>= acc!216 0)) (or (= acc!216 (+ (* (- 1) (size!206 (tail!1047 l!215))) (ite ((_ is Nil!1048) l!215) acc!216 (ite ((_ is Cons!1045) l!215) (sizeTailRecAcc!217 l!215 (+ 1 acc!216)) error_value!1051)))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_3 ?z) (tail!1047 l!215))) ) (not (ite ((_ is Nil!1048) l!215) true (ite ((_ is Cons!1045) l!215) (not (forall ((?z I_sizeTailRecAcc!217)) (not (and (= (sizeTailRecAcc!217_arg_0_1 ?z) l!215) (= (sizeTailRecAcc!217_arg_1_2 ?z) (+ 1 acc!216)))) )) true))))) )))
(check-sat)
(exit)
