...
(assert (not (forall ((BOUND_VARIABLE_462 (_ BitVec 32))) (or (not (and (isNNF!212 (simplify!206 (Literal!1196 BOUND_VARIABLE_462))) (not (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (simplify!206 (Literal!1196 BOUND_VARIABLE_462)))) )) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (Literal!1196 BOUND_VARIABLE_462))) )))) (or (isNNF!212 (Literal!1196 BOUND_VARIABLE_462)) (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (Literal!1196 BOUND_VARIABLE_462))) ))) )))
(check-sat)
(exit)
