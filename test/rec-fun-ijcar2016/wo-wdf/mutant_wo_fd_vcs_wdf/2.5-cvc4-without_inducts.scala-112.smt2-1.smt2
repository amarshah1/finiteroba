...
(assert (not (forall ((n!541 Nat!2608) (m!542 Nat!2608) (xs!543 Lst!2612)) (or (= (take!260 n!541 xs!543) (drop!257 m!542 (take!260 (plus!237 n!541 m!542) (drop!257 m!542 xs!543)))) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) n!541) (= (take!260_arg_1_2 ?z) xs!543))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_3 ?z) m!542) (= (drop!257_arg_1_4 ?z) (take!260 (plus!237 n!541 m!542) (drop!257 m!542 xs!543))))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) (plus!237 n!541 m!542)) (= (take!260_arg_1_2 ?z) (drop!257 m!542 xs!543)))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_5 ?z) n!541) (= (plus!237_arg_1_6 ?z) m!542))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_3 ?z) m!542) (= (drop!257_arg_1_4 ?z) xs!543))) )) )))
(check-sat)
(exit)
