...
(assert (not (forall ((t!218 IntTree!977)) (or (or (computesPositive!215 t!218) (forall ((?z I_computesPositive!215)) (not (= (computesPositive!215_arg_0_2 ?z) t!218)) )) (or (identityForPositive!217 t!218) (forall ((?z I_identityForPositive!217)) (not (= (identityForPositive!217_arg_0_7 ?z) t!218)) )) (not (and (repOk!206 t!218) (not (forall ((?z I_repOk!206)) (not (= (repOk!206_arg_0_1 ?z) t!218)) ))))) )))
(check-sat)
(exit)
