...
(assert (not (forall ((a!363 Nat!2002) (b!364 Nat!2002) (c!365 Nat!2002)) (or (= (nmax!246 (nmax!246 a!363 b!364) c!365) (nmax!246 c!365 (nmax!246 b!364 a!363))) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) (nmax!246 a!363 b!364)) (= (nmax!246_arg_1_2 ?z) c!365))) ) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) a!363) (= (nmax!246_arg_1_2 ?z) b!364))) ) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) c!365) (= (nmax!246_arg_1_2 ?z) (nmax!246 b!364 a!363)))) ) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) b!364) (= (nmax!246_arg_1_2 ?z) a!363))) )) )))
(check-sat)
(exit)
