...
(assert (not (forall ((xs!553 Lst!2665) (ys!554 Lst!2665) (zs!555 Lst!2665)) (or (= (zappend!291 (zip!288 (take!260 (len!254 ys!554) xs!553) ys!554) (zip!288 (drop!257 (len!254 ys!554) xs!553) zs!555)) (zip!288 xs!553 (append!252 ys!554 zs!555))) (forall ((?z I_zappend!291)) (not (and (= (zappend!291_arg_0_5 ?z) (zip!288 (take!260 (len!254 ys!554) xs!553) ys!554)) (= (zappend!291_arg_1_6 ?z) (zip!288 (drop!257 (len!254 ys!554) xs!553) zs!555)))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) (take!260 (len!254 ys!554) xs!553)) (= (zip!288_arg_1_2 ?z) ys!554))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_7 ?z) (len!254 ys!554)) (= (take!260_arg_1_8 ?z) xs!553))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_9 ?z) ys!554)) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) (drop!257 (len!254 ys!554) xs!553)) (= (zip!288_arg_1_2 ?z) zs!555))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_10 ?z) (len!254 ys!554)) (= (drop!257_arg_1_11 ?z) xs!553))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_9 ?z) ys!554)) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) xs!553) (= (zip!288_arg_1_2 ?z) (append!252 ys!554 zs!555)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) ys!554) (= (append!252_arg_1_4 ?z) zs!555))) )) )))
(check-sat)
(exit)
