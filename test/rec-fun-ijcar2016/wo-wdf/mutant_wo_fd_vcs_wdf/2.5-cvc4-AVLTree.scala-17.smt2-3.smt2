...
(assert (not (forall ((t!241 Tree!1170)) (or (not (and (isBST!232 t!241) (not (forall ((?z I_isBST!232)) (not (= (isBST!232_arg_0_10 ?z) t!241)) )))) (or (= error_value!1186 (treeMin!230 t!241)) (forall ((?z I_treeMin!230)) (not (= (treeMin!230_arg_0_11 ?z) t!241)) ))) )))
(check-sat)
(exit)
