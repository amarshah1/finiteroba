...
(assert (not (forall ((i!514 Nat!2513) (xs!515 Lst!2517)) (or (= (rev!275 (drop!257 i!514 xs!515)) (take!260 (len!254 xs!515) (rev!275 xs!515))) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_1 ?z) (drop!257 i!514 xs!515))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_4 ?z) i!514) (= (drop!257_arg_1_5 ?z) xs!515))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_6 ?z) (len!254 xs!515)) (= (take!260_arg_1_7 ?z) (rev!275 xs!515)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_10 ?z) xs!515)) ) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_1 ?z) xs!515)) )) )))
(check-sat)
(exit)
