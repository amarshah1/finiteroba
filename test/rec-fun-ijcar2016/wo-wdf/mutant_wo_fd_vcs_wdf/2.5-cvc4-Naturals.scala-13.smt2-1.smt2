...
(assert (not (forall ((y!225 Nat!960) (BOUND_VARIABLE_290 Nat!960)) (or (= (plus!207 BOUND_VARIABLE_290 y!225) (plus!207 y!225 BOUND_VARIABLE_290)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) BOUND_VARIABLE_290) (= (plus!207_arg_1_2 ?z) y!225))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!225) (= (plus!207_arg_1_2 ?z) BOUND_VARIABLE_290))) )) )))
(check-sat)
(exit)
