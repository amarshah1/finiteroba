...
(assert (not (forall ((n!360 Nat!1996) (m!361 Nat!1996)) (or (leq!234 n!360 (plus!237 m!361 n!360)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) n!360) (= (leq!234_arg_1_2 ?z) (plus!237 m!361 n!360)))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_5 ?z) m!361) (= (plus!237_arg_1_6 ?z) n!360))) )) )))
(check-sat)
(exit)
