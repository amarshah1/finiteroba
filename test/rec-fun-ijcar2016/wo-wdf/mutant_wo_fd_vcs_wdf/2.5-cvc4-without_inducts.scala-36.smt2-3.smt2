...
(assert (not (forall ((n!304 Nat!1831) (xs!305 Lst!1835)) (or (= (append!252 xs!305 (drop!257 n!304 xs!305)) (take!260 n!304 xs!305)) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_1 ?z) xs!305) (= (append!252_arg_1_2 ?z) (drop!257 n!304 xs!305)))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_5 ?z) n!304) (= (drop!257_arg_1_6 ?z) xs!305))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_3 ?z) n!304) (= (take!260_arg_1_4 ?z) xs!305))) )) )))
(check-sat)
(exit)
