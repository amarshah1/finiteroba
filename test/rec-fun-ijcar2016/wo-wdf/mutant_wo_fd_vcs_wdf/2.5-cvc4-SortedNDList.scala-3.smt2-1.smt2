...
(assert (not (forall ((node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32)) (BOUND_VARIABLE_351 (_ BitVec 32)) (BOUND_VARIABLE_352 (_ BitVec 32)) (BOUND_VARIABLE_353 SortedNDList!896)) (or (or (sndInvariant!206 (ListNode!898 node!208 dist!209 (ListNode!898 BOUND_VARIABLE_351 BOUND_VARIABLE_352 BOUND_VARIABLE_353))) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!898 node!208 dist!209 (ListNode!898 BOUND_VARIABLE_351 BOUND_VARIABLE_352 BOUND_VARIABLE_353)))) )) (bvslt dist!209 (_ bv0 32)) (bvslt node!208 (_ bv0 32)) (not (and (sndInvariant!206 (ListNode!898 BOUND_VARIABLE_351 BOUND_VARIABLE_352 BOUND_VARIABLE_353)) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!898 BOUND_VARIABLE_351 BOUND_VARIABLE_352 BOUND_VARIABLE_353))) )))) (and (not (bvslt dist!209 (_ bv0 32))) (not (bvslt node!208 (_ bv0 32))) (or (sndInvariant!206 BOUND_VARIABLE_353) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) BOUND_VARIABLE_353)) )) (not (and (sndInvariant!206 (ListNode!898 node!208 dist!209 BOUND_VARIABLE_353)) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!898 node!208 dist!209 BOUND_VARIABLE_353))) )))))) )))
(check-sat)
(exit)
