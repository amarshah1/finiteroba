...
(assert (not (forall ((n!340 Nat!1928) (x!341 Nat!1928) (xs!342 Lst!1932)) (or (= (drop!257 (succ!1929 n!340) xs!342) (drop!257 n!340 (cons!1933 x!341 xs!342))) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) (succ!1929 n!340)) (= (drop!257_arg_1_2 ?z) xs!342))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!340) (= (drop!257_arg_1_2 ?z) (cons!1933 x!341 xs!342)))) )) )))
(check-sat)
(exit)
