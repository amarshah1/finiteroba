...
(assert (not (forall ((list!208 List!880) (f!207 (Array (_ BitVec 32) (_ BitVec 32)))) (or (positive!206 (ite ((_ is Cons!881) list!208) (Cons!881 (ite (bvslt (select f!207 (head!882 list!208)) (_ bv4294967295 32)) (_ bv0 32) (select f!207 (head!882 list!208))) (positiveMap_failling_1!209 f!207 error_value!887)) (ite ((_ is Nil!884) list!208) Nil!884 (tail!883 list!208)))) (forall ((?z I_positive!206)) (not (= (positive!206_arg_0_1 ?z) (ite ((_ is Cons!881) list!208) (Cons!881 (ite (bvslt (select f!207 (head!882 list!208)) (_ bv4294967295 32)) (_ bv0 32) (select f!207 (head!882 list!208))) (positiveMap_failling_1!209 f!207 error_value!887)) (ite ((_ is Nil!884) list!208) Nil!884 (tail!883 list!208))))) ) (not (ite ((_ is Cons!881) list!208) (not (forall ((?z I_positiveMap_failling_1!209)) (not (and (= (positiveMap_failling_1!209_arg_0_2 ?z) f!207) (= (positiveMap_failling_1!209_arg_1_3 ?z) error_value!887))) )) true))) )))
(check-sat)
(exit)
