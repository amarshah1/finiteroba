...
(assert (not (forall ((n!355 Nat!1971) (xs!356 Lst!1975)) (or (= (len!254 xs!356) (minus!240 (len!254 (drop!257 n!355 xs!356)) n!355)) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) xs!356)) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_4 ?z) (len!254 (drop!257 n!355 xs!356))) (= (minus!240_arg_1_5 ?z) n!355))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) (drop!257 n!355 xs!356))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_2 ?z) n!355) (= (drop!257_arg_1_3 ?z) xs!356))) )) )))
(check-sat)
(exit)
