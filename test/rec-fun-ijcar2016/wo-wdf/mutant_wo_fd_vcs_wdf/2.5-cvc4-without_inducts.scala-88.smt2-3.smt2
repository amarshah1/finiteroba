...
(assert (not (forall ((n!462 Nat!2337) (m!463 Nat!2337) (xs!464 Lst!2341)) (or (= (drop!257 (plus!237 n!462 m!463) (drop!257 m!463 xs!464)) (drop!257 n!462 xs!464)) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) (plus!237 n!462 m!463)) (= (drop!257_arg_1_2 ?z) (drop!257 m!463 xs!464)))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) n!462) (= (plus!237_arg_1_4 ?z) m!463))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) m!463) (= (drop!257_arg_1_2 ?z) xs!464))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!462) (= (drop!257_arg_1_2 ?z) xs!464))) )) )))
(check-sat)
(exit)
