...
(assert (not (forall ((a!403 Nat!2093) (b!404 Nat!2093)) (or (= (= a!403 b!404) (leq!234 b!404 (nmin!249 a!403 b!404))) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_5 ?z) b!404) (= (leq!234_arg_1_6 ?z) (nmin!249 a!403 b!404)))) ) (forall ((?z I_nmin!249)) (not (and (= (nmin!249_arg_0_1 ?z) a!403) (= (nmin!249_arg_1_2 ?z) b!404))) )) )))
(check-sat)
(exit)
