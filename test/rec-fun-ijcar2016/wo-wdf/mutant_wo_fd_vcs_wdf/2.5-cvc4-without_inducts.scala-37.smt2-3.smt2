...
(assert (not (forall ((n!307 Nat!1843) (l!308 Lst!1847) (m!309 Lst!1847)) (or (= (plus!237 (count!263 n!307 l!308) (count!263 (count!263 n!307 (append!252 l!308 m!309)) m!309)) n!307) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_1 ?z) (count!263 n!307 l!308)) (= (plus!237_arg_1_2 ?z) (count!263 (count!263 n!307 (append!252 l!308 m!309)) m!309)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!307) (= (count!263_arg_1_4 ?z) l!308))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) (count!263 n!307 (append!252 l!308 m!309))) (= (count!263_arg_1_4 ?z) m!309))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!307) (= (count!263_arg_1_4 ?z) (append!252 l!308 m!309)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_5 ?z) l!308) (= (append!252_arg_1_6 ?z) m!309))) )) )))
(check-sat)
(exit)
