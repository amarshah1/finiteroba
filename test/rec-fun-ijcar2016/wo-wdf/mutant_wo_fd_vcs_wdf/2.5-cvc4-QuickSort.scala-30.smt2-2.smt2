...
(assert (not (forall ((e!251 (_ BitVec 32)) (n!250 (_ BitVec 32))) (or (or (contains!209 (greater!227 n!250 Nil!1256) e!251) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (greater!227 n!250 Nil!1256)) (= (contains!209_arg_1_2 ?z) e!251))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_3 ?z) n!250) (= (greater!227_arg_1_4 ?z) Nil!1256))) )) (or (contains!209 Nil!1256 e!251) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) Nil!1256) (= (contains!209_arg_1_2 ?z) e!251))) )) (bvslt n!250 e!251)) )))
(check-sat)
(exit)
