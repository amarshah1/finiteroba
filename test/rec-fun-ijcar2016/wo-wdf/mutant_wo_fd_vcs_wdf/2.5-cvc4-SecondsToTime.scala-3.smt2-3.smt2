...
(assert (not (forall ((total!216 Int)) (or (not (and (prop!213 total!216 (_1!906 (rec2!227 total!216 total!216 0 0)) (_2!907 (rec2!227 total!216 total!216 0 0)) (_3!908 (rec2!227 total!216 total!216 0 0))) (not (forall ((?z I_prop!213)) (not (and (= (prop!213_arg_0_9 ?z) total!216) (= (prop!213_arg_1_10 ?z) (_1!906 (rec2!227 total!216 total!216 0 0))) (= (prop!213_arg_2_11 ?z) (_2!907 (rec2!227 total!216 total!216 0 0))) (= (prop!213_arg_3_12 ?z) (_3!908 (rec2!227 total!216 total!216 0 0))))) )) (not (forall ((?z I_rec2!227)) (not (and (= (rec2!227_arg_0_1 ?z) total!216) (= (rec2!227_arg_1_2 ?z) total!216) (= (rec2!227_arg_2_3 ?z) 0) (= (rec2!227_arg_3_4 ?z) 0))) )) (not (forall ((?z I_rec2!227)) (not (and (= (rec2!227_arg_0_1 ?z) total!216) (= (rec2!227_arg_1_2 ?z) total!216) (= (rec2!227_arg_2_3 ?z) 0) (= (rec2!227_arg_3_4 ?z) 0))) )) (not (forall ((?z I_rec2!227)) (not (and (= (rec2!227_arg_0_1 ?z) total!216) (= (rec2!227_arg_1_2 ?z) total!216) (= (rec2!227_arg_2_3 ?z) 0) (= (rec2!227_arg_3_4 ?z) 0))) )))) (>= total!216 0)) )))
(check-sat)
(exit)
