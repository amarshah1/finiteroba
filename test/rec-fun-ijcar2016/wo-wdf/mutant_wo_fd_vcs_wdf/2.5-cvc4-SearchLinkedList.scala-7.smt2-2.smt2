...
(assert (not (forall ((list!215 List!929)) (or (ite (contains!209 list!215 (_ bv0 32)) (or (firstZeroAtPos!214 list!215 (size!206 list!215)) (forall ((?z I_firstZeroAtPos!214)) (not (and (= (firstZeroAtPos!214_arg_0_4 ?z) list!215) (= (firstZeroAtPos!214_arg_1_5 ?z) (size!206 list!215)))) ) (forall ((?z I_size!206)) (not (= (size!206_arg_0_6 ?z) list!215)) )) true) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_2 ?z) list!215) (= (contains!209_arg_1_3 ?z) (_ bv0 32)))) )) )))
(check-sat)
(exit)
