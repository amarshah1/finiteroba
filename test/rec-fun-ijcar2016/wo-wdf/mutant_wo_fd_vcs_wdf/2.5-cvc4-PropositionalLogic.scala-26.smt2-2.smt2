...
(assert (not (forall ((BOUND_VARIABLE_433 Formula!1336) (BOUND_VARIABLE_434 Formula!1336)) (or (and (or (isSimplified!208 BOUND_VARIABLE_433) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) BOUND_VARIABLE_433)) )) (not (and (= (simplify!206 BOUND_VARIABLE_433) BOUND_VARIABLE_433) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) BOUND_VARIABLE_433)) ))))) (not (and (isSimplified!208 (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) )))) (or (= (simplify!206 (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (Implies!1340 BOUND_VARIABLE_433 (simplify!206 BOUND_VARIABLE_434))) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (Implies!1340 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) ) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) BOUND_VARIABLE_434)) ))) )))
(check-sat)
(exit)
