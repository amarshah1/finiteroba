...
(assert (not (forall ((BOUND_VARIABLE_433 Formula!1320) (BOUND_VARIABLE_434 Formula!1320)) (or (and (or (isSimplified!208 BOUND_VARIABLE_434) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) BOUND_VARIABLE_434)) )) (not (and (= (simplify!206 BOUND_VARIABLE_434) BOUND_VARIABLE_434) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) BOUND_VARIABLE_434)) ))))) (and (or (isSimplified!208 BOUND_VARIABLE_433) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) BOUND_VARIABLE_433)) )) (not (= (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434) BOUND_VARIABLE_433))) (not (and (isSimplified!208 (simplify!206 BOUND_VARIABLE_433)) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (simplify!206 BOUND_VARIABLE_433))) )) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) BOUND_VARIABLE_433)) )))) (or (= (simplify!206 (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434)) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (And!1321 BOUND_VARIABLE_433 BOUND_VARIABLE_434))) ))) )))
(check-sat)
(exit)
