...
(assert (not (forall ((x!384 Nat!2044)) (or (mem!270 x!384 (cons!2049 x!384 nil!2052)) (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!384) (= (mem!270_arg_1_2 ?z) (cons!2049 x!384 nil!2052)))) )) )))
(check-sat)
(exit)
