...
(assert (not (forall ((l!208 IntPairList!986)) (or (>= (ite ((_ is IPCons!987) l!208) 0 (ite ((_ is IPNil!990) l!208) (+ 1 (iplSize!209 (tail!989 l!208))) error_value!996)) 0) (not (ite ((_ is IPCons!987) l!208) true (ite ((_ is IPNil!990) l!208) (not (forall ((?z I_iplSize!209)) (not (= (iplSize!209_arg_0_1 ?z) (tail!989 l!208))) )) true)))) )))
(check-sat)
(exit)
