...
(assert (not (forall ((BOUND_VARIABLE_415 Formula!1368)) (or (and (or (= (simplify!206 BOUND_VARIABLE_415) BOUND_VARIABLE_415) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) BOUND_VARIABLE_415)) )) (not (and (isSimplified!208 BOUND_VARIABLE_415) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) BOUND_VARIABLE_415)) ))))) (not (and (isSimplified!208 (Not!1377 BOUND_VARIABLE_415)) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (Not!1377 BOUND_VARIABLE_415))) )))) (or (= (simplify!206 (Not!1377 BOUND_VARIABLE_415)) (Not!1377 BOUND_VARIABLE_415)) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (Not!1377 BOUND_VARIABLE_415))) ))) )))
(check-sat)
(exit)
