...
(assert (not (forall ((heap!221 Heap!1069) (element!220 (_ BitVec 32))) (or (not (and (hasLeftistProperty!210 heap!221) (not (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) heap!221)) )))) (or (= (bvadd (heapSize!212 heap!221) (_ bv1 32)) element!220) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) heap!221)) ))) )))
(check-sat)
(exit)
