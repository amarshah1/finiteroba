...
(assert (not (forall ((xs!440 Lst!2264)) (or (= xs!440 (take!260 (minus!240 (len!254 (butlast!267 xs!440)) (succ!2270 zero!2272)) xs!440)) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_2 ?z) (minus!240 (len!254 (butlast!267 xs!440)) (succ!2270 zero!2272))) (= (take!260_arg_1_3 ?z) xs!440))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_4 ?z) (len!254 (butlast!267 xs!440))) (= (minus!240_arg_1_5 ?z) (succ!2270 zero!2272)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_6 ?z) (butlast!267 xs!440))) ) (forall ((?z I_butlast!267)) (not (= (butlast!267_arg_0_1 ?z) xs!440)) )) )))
(check-sat)
(exit)
