...
(assert (not (forall ((t!218 IntTree!977)) (not (and (identityForPositive!217 t!218) (not (forall ((?z I_identityForPositive!217)) (not (= (identityForPositive!217_arg_0_7 ?z) t!218)) )))) )))
(check-sat)
(exit)
