...
(assert (not (forall ((x!376 Nat!2022) (l!377 Lst!2026)) (not (and (mem!270 x!376 l!377) (not (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!376) (= (mem!270_arg_1_2 ?z) l!377))) )))) )))
(check-sat)
(exit)
