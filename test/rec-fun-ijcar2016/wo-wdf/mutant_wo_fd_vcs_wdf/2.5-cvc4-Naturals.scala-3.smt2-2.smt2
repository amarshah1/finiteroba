...
(assert (not (forall ((BOUND_VARIABLE_287 Nat!910)) (or (not (and (= (plus!207 BOUND_VARIABLE_287 Zero!913) BOUND_VARIABLE_287) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) BOUND_VARIABLE_287) (= (plus!207_arg_1_2 ?z) Zero!913))) )))) (or (= (Succ!911 BOUND_VARIABLE_287) (plus!207 (Succ!911 BOUND_VARIABLE_287) Zero!913)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!911 BOUND_VARIABLE_287)) (= (plus!207_arg_1_2 ?z) Zero!913))) ))) )))
(check-sat)
(exit)
