...
(assert (not (forall ((BOUND_VARIABLE_463 (_ BitVec 32))) (or (= (eval!210 (nnf!206 (Variable!1116 BOUND_VARIABLE_463))) (eval!210 (Variable!1116 BOUND_VARIABLE_463))) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (nnf!206 (Variable!1116 BOUND_VARIABLE_463)))) ) (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Variable!1116 BOUND_VARIABLE_463))) ) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (Variable!1116 BOUND_VARIABLE_463))) )) )))
(check-sat)
(exit)
