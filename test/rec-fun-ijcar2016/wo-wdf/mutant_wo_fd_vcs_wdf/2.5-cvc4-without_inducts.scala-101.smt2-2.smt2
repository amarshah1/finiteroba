...
(assert (not (forall ((m!504 Nat!2484) (n!503 Nat!2484)) (or (or (leq!234 n!503 (succ!2485 m!504)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) n!503) (= (leq!234_arg_1_2 ?z) (succ!2485 m!504)))) )) (not (and (leq!234 m!504 n!503) (not (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) m!504) (= (leq!234_arg_1_2 ?z) n!503))) ))))) )))
(check-sat)
(exit)
