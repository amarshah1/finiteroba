...
(assert (not (forall ((n!240 (_ BitVec 32)) (BOUND_VARIABLE_396 (_ BitVec 32)) (BOUND_VARIABLE_397 List!1153)) (or (or (ite ((_ is Some!1160) (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) (not (and (= (i!1161 (max!216 (equals!239 n!240 BOUND_VARIABLE_397))) n!240) (not (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 BOUND_VARIABLE_397))) )) (not (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) BOUND_VARIABLE_397))) )))) (or (ite ((_ is None!1159) (max!216 (equals!239 n!240 BOUND_VARIABLE_397))) false (not error_value!1165)) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 BOUND_VARIABLE_397))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) BOUND_VARIABLE_397))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) )) (or (ite ((_ is Some!1160) (max!216 (equals!239 n!240 BOUND_VARIABLE_397))) (or (= (i!1161 (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) n!240) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) )) (or (ite ((_ is None!1159) (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) true error_value!1166) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 BOUND_VARIABLE_397))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) BOUND_VARIABLE_397))) ))) )))
(check-sat)
(exit)
