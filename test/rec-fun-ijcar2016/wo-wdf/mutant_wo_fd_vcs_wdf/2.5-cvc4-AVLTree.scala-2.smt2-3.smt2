...
(assert (not (forall ((t!223 Tree!1015)) (not (and (bvslt (ite ((_ is Leaf!1016) t!223) (_ bv0 32) (size!224 (right!1020 t!223))) (_ bv0 32)) (ite ((_ is Leaf!1016) t!223) true (not (forall ((?z I_size!224)) (not (= (size!224_arg_0_1 ?z) (right!1020 t!223))) ))))) )))
(check-sat)
(exit)
