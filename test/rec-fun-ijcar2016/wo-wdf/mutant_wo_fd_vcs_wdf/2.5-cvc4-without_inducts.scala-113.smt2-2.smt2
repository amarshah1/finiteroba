...
(assert (not (forall ((n!545 Nat!2620) (xs!546 Lst!2624) (ys!547 Lst!2624)) (or (= (zip!288 (take!260 n!545 xs!546) (take!260 n!545 ys!547)) (ztake!297 n!545 (zip!288 xs!546 ys!547))) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_3 ?z) (take!260 n!545 xs!546)) (= (zip!288_arg_1_4 ?z) (take!260 n!545 ys!547)))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_5 ?z) n!545) (= (take!260_arg_1_6 ?z) xs!546))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_5 ?z) n!545) (= (take!260_arg_1_6 ?z) ys!547))) ) (forall ((?z I_ztake!297)) (not (and (= (ztake!297_arg_0_1 ?z) n!545) (= (ztake!297_arg_1_2 ?z) (zip!288 xs!546 ys!547)))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_3 ?z) xs!546) (= (zip!288_arg_1_4 ?z) ys!547))) )) )))
(check-sat)
(exit)
