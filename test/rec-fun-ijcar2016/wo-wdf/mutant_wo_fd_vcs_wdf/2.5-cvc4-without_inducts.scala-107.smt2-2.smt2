...
(assert (not (forall ((n!524 Nat!2554) (t!526 Lst!2558) (h!525 Nat!2554)) (or (= (plus!237 (count!263 n!524 t!526) (count!263 (count!263 n!524 (cons!2559 h!525 t!526)) (cons!2559 h!525 nil!2562))) n!524) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_1 ?z) (count!263 n!524 t!526)) (= (plus!237_arg_1_2 ?z) (count!263 (count!263 n!524 (cons!2559 h!525 t!526)) (cons!2559 h!525 nil!2562))))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!524) (= (count!263_arg_1_4 ?z) t!526))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) (count!263 n!524 (cons!2559 h!525 t!526))) (= (count!263_arg_1_4 ?z) (cons!2559 h!525 nil!2562)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!524) (= (count!263_arg_1_4 ?z) (cons!2559 h!525 t!526)))) )) )))
(check-sat)
(exit)
