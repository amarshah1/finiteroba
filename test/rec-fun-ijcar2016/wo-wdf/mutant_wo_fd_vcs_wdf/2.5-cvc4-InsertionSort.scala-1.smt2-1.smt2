...
(assert (not (forall ((l!205 List!911)) (or (>= (ite ((_ is Cons!912) l!205) 0 (ite ((_ is Nil!915) l!205) (+ 1 (size!206 (tail!914 l!205))) error_value!917)) 0) (not (ite ((_ is Cons!912) l!205) true (ite ((_ is Nil!915) l!205) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!914 l!205))) )) true)))) )))
(check-sat)
(exit)
