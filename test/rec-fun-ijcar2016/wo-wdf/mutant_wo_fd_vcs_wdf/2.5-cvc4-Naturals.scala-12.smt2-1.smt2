...
(assert (not (forall ((y!222 Nat!955)) (or (= (plus!207 (Succ!956 (plus!207 y!222 Zero!958)) Zero!958) (Succ!956 y!222)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!956 (plus!207 y!222 Zero!958))) (= (plus!207_arg_1_2 ?z) Zero!958))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!222) (= (plus!207_arg_1_2 ?z) Zero!958))) )) )))
(check-sat)
(exit)
