...
(assert (not (forall ((xs!495 Lst!2454)) (or (= (minus!240 (len!254 xs!495) (succ!2460 zero!2462)) (len!254 (butlast!267 xs!495))) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_3 ?z) (len!254 xs!495)) (= (minus!240_arg_1_4 ?z) (succ!2460 zero!2462)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) xs!495)) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) (butlast!267 xs!495))) ) (forall ((?z I_butlast!267)) (not (= (butlast!267_arg_0_2 ?z) xs!495)) )) )))
(check-sat)
(exit)
