...
(assert (not (forall ((h!211 Heap!937)) (or ((_ is Leaf!938) h!211) (not (and (bvslt (size!210 (ite ((_ is Node!939) h!211) (merge!215 (left!942 h!211) (right!943 h!211)) (ite (not (hasLeftistProperty!208 h!211)) h!211 error_value!949))) (bvadd (size!210 h!211) (_ bv4294967295 32))) (not (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) (ite ((_ is Node!939) h!211) (merge!215 (left!942 h!211) (right!943 h!211)) (ite (not (hasLeftistProperty!208 h!211)) h!211 error_value!949)))) )) (ite ((_ is Node!939) h!211) (not (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_7 ?z) (left!942 h!211)) (= (merge!215_arg_1_8 ?z) (right!943 h!211)))) )) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) h!211)) ))) (not (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) h!211)) ))))) )))
(check-sat)
(exit)
