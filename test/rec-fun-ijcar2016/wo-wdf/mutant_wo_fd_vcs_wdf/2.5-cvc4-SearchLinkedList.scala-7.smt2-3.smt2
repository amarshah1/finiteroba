...
(assert (not (forall ((list!215 List!929)) (or (= (firstZero!211 list!215) (size!206 list!215)) (forall ((?z I_firstZero!211)) (not (= (firstZero!211_arg_0_1 ?z) list!215)) ) (forall ((?z I_size!206)) (not (= (size!206_arg_0_6 ?z) list!215)) )) )))
(check-sat)
(exit)
