...
(assert (not (forall ((n!234 (_ BitVec 32)) (BOUND_VARIABLE_396 (_ BitVec 32)) (BOUND_VARIABLE_397 List!1109)) (or (or (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) (not (and ((_ is None!1115) (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) (not (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 BOUND_VARIABLE_397))) )) (not (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) BOUND_VARIABLE_397))) )))) (or (ite (bvslt (i!1117 (max!216 (smaller!233 n!234 BOUND_VARIABLE_397))) n!234) false (not error_value!1121)) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 BOUND_VARIABLE_397))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) BOUND_VARIABLE_397))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 BOUND_VARIABLE_397))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) BOUND_VARIABLE_397))) )) (or (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) (or (bvslt (i!1117 (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) n!234) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) )) (or (ite ((_ is None!1115) (max!216 (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) true error_value!1122) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (Cons!1110 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) ))) )))
(check-sat)
(exit)
