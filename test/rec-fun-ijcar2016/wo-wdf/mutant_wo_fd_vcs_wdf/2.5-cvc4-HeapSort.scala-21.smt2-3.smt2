...
(assert (not (forall ((h!230 Heap!1134) (l!231 List!1141)) (or ((_ is Leaf!1135) h!230) (or (= (listSize!229 (ite (not (hasLeftistProperty!210 h!230)) l!231 (removeElements!232 (removeMax!226 h!230) (Cons!1142 (findMax!224 h!230) l!231)))) (bvadd (heapSize!212 h!230) (listSize!229 l!231))) (forall ((?z I_listSize!229)) (not (= (listSize!229_arg_0_5 ?z) (ite (not (hasLeftistProperty!210 h!230)) l!231 (removeElements!232 (removeMax!226 h!230) (Cons!1142 (findMax!224 h!230) l!231))))) ) (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) h!230)) ) (not (ite (not (hasLeftistProperty!210 h!230)) true (and (not (forall ((?z I_removeElements!232)) (not (and (= (removeElements!232_arg_0_11 ?z) (removeMax!226 h!230)) (= (removeElements!232_arg_1_12 ?z) (Cons!1142 (findMax!224 h!230) l!231)))) )) (not (forall ((?z I_removeMax!226)) (not (= (removeMax!226_arg_0_10 ?z) h!230)) )) (not (forall ((?z I_findMax!224)) (not (= (findMax!224_arg_0_6 ?z) h!230)) ))))) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) h!230)) ) (forall ((?z I_listSize!229)) (not (= (listSize!229_arg_0_5 ?z) l!231)) ))) )))
(check-sat)
(exit)
