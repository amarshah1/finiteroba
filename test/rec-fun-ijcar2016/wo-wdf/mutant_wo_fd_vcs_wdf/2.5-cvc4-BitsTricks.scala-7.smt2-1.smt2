...
(assert (not (forall ((n!217 (_ BitVec 32)) (x!216 (_ BitVec 32))) (or (or (= (isBitNSet!213 (bvor x!216 (bvshl (_ bv1 32) n!217)) n!217) (_ bv0 32)) (forall ((?z I_isBitNSet!213)) (not (and (= (isBitNSet!213_arg_0_1 ?z) (bvor x!216 (bvshl (_ bv1 32) n!217))) (= (isBitNSet!213_arg_1_2 ?z) n!217))) )) (bvslt n!217 (_ bv0 32)) (bvslt n!217 (_ bv32 32))) )))
(check-sat)
(exit)
