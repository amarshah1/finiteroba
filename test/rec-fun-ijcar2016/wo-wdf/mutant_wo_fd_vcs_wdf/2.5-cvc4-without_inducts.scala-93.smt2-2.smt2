...
(assert (not (forall ((xs!480 Lst!2403) (ys!481 Lst!2403)) (or (= (last!265 xs!480) (ite (= ys!481 nil!2407) (last!265 (append!252 xs!480 ys!481)) (last!265 ys!481))) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) xs!480)) ) (not (ite (= ys!481 nil!2407) (and (not (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) (append!252 xs!480 ys!481))) )) (not (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!480) (= (append!252_arg_1_3 ?z) ys!481))) ))) (not (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) ys!481)) ))))) )))
(check-sat)
(exit)
