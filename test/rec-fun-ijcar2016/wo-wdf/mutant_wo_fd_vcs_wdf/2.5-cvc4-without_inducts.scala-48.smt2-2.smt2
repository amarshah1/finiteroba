...
(assert (not (forall ((x!344 Nat!1938) (l!345 Lst!1942)) (or (= (len!254 (insort!281 x!344 l!345)) (len!254 l!345)) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) (insort!281 x!344 l!345))) ) (forall ((?z I_insort!281)) (not (and (= (insort!281_arg_0_2 ?z) x!344) (= (insort!281_arg_1_3 ?z) l!345))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) l!345)) )) )))
(check-sat)
(exit)
