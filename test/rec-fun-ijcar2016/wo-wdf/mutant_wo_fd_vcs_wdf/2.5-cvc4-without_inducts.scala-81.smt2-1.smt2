...
(assert (not (forall ((xs!440 Lst!2264)) (or (= (butlast!267 xs!440) (take!260 (len!254 xs!440) xs!440)) (forall ((?z I_butlast!267)) (not (= (butlast!267_arg_0_1 ?z) xs!440)) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_2 ?z) (len!254 xs!440)) (= (take!260_arg_1_3 ?z) xs!440))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_6 ?z) xs!440)) )) )))
(check-sat)
(exit)
