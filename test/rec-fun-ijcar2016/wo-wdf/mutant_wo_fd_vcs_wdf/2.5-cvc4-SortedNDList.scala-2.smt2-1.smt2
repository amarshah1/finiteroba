...
(assert (not (forall ((node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32))) (or (bvslt node!208 (_ bv0 32)) (bvslt dist!209 (_ bv0 32)) (not (and (sndInvariant!206 ListEnd!890) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) ListEnd!890)) )))) (or (sndInvariant!206 (ListNode!891 node!208 dist!209 ListEnd!890)) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!891 node!208 dist!209 ListEnd!890))) ))) )))
(check-sat)
(exit)
