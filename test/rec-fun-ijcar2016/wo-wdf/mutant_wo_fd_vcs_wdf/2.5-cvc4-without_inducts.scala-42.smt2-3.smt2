...
(assert (not (forall ((n!325 Nat!1895) (m!326 Nat!1895)) (or (= m!326 (minus!240 (plus!237 n!325 m!326) n!325)) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (plus!237 n!325 m!326)) (= (minus!240_arg_1_2 ?z) n!325))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) n!325) (= (plus!237_arg_1_4 ?z) m!326))) )) )))
(check-sat)
(exit)
