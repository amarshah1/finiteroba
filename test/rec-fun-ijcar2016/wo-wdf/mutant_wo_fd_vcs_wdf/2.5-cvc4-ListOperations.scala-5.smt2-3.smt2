...
(assert (not (forall ((l1!210 List!1006) (l2!211 List!1006)) (or (not (and (= (size!206 l1!210) (size!206 l2!211)) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l1!210)) )) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l2!211)) )))) (or (= (size!206 l1!210) (iplSize!209 (IPCons!1013 (IP!1018 (head!1008 l1!210) (head!1008 l2!211)) (zip!212 (tail!1009 l1!210) (tail!1009 l2!211))))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l1!210)) ) (forall ((?z I_iplSize!209)) (not (= (iplSize!209_arg_0_2 ?z) (IPCons!1013 (IP!1018 (head!1008 l1!210) (head!1008 l2!211)) (zip!212 (tail!1009 l1!210) (tail!1009 l2!211))))) ) (forall ((?z I_zip!212)) (not (and (= (zip!212_arg_0_3 ?z) (tail!1009 l1!210)) (= (zip!212_arg_1_4 ?z) (tail!1009 l2!211)))) ))) )))
(check-sat)
(exit)
