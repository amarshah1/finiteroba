...
(assert (not (forall ((x!319 Nat!1878) (l!320 Lst!1882)) (or (= (plus!237 (succ!1879 zero!1881) (count!263 x!319 (cons!1883 x!319 l!320))) (count!263 x!319 l!320)) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_1 ?z) (succ!1879 zero!1881)) (= (plus!237_arg_1_2 ?z) (count!263 x!319 (cons!1883 x!319 l!320))))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) x!319) (= (count!263_arg_1_4 ?z) (cons!1883 x!319 l!320)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) x!319) (= (count!263_arg_1_4 ?z) l!320))) )) )))
(check-sat)
(exit)
