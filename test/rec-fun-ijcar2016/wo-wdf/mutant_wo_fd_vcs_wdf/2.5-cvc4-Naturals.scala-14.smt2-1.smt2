...
(assert (not (forall ((y!225 Nat!965)) (or (= (plus!207 y!225 Zero!968) (plus!207 Zero!968 y!225)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!225) (= (plus!207_arg_1_2 ?z) Zero!968))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) Zero!968) (= (plus!207_arg_1_2 ?z) y!225))) )) )))
(check-sat)
(exit)
