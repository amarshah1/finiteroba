...
(assert (not (forall ((t!208 Tree!915)) (not (and (bvslt (ite ((_ is Leaf!916) t!208) (_ bv0 32) (ite ((_ is Node!917) t!208) (ite (bvslt (height!209 (right!920 t!208)) (height!209 (left!919 t!208))) (bvadd (height!209 (left!919 t!208)) (_ bv1 32)) (bvadd error_value!922 (_ bv1 32))) (height!209 (right!920 t!208)))) (_ bv0 32)) (ite ((_ is Leaf!916) t!208) true (ite ((_ is Node!917) t!208) (and (not (forall ((?z I_height!209)) (not (= (height!209_arg_0_1 ?z) (right!920 t!208))) )) (not (forall ((?z I_height!209)) (not (= (height!209_arg_0_1 ?z) (left!919 t!208))) )) (ite (bvslt (height!209 (right!920 t!208)) (height!209 (left!919 t!208))) (not (forall ((?z I_height!209)) (not (= (height!209_arg_0_1 ?z) (left!919 t!208))) )) true)) (not (forall ((?z I_height!209)) (not (= (height!209_arg_0_1 ?z) (right!920 t!208))) )))))) )))
(check-sat)
(exit)
