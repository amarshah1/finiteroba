...
(assert (not (forall ((n!412 Nat!2120) (h!413 Nat!2120) (t!414 Lst!2124)) (or (= (plus!237 (count!263 n!412 (cons!2125 h!413 nil!2128)) (count!263 n!412 (cons!2125 h!413 t!414))) (count!263 n!412 t!414)) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_1 ?z) (count!263 n!412 (cons!2125 h!413 nil!2128))) (= (plus!237_arg_1_2 ?z) (count!263 n!412 (cons!2125 h!413 t!414))))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!412) (= (count!263_arg_1_4 ?z) (cons!2125 h!413 nil!2128)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!412) (= (count!263_arg_1_4 ?z) (cons!2125 h!413 t!414)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!412) (= (count!263_arg_1_4 ?z) t!414))) )) )))
(check-sat)
(exit)
