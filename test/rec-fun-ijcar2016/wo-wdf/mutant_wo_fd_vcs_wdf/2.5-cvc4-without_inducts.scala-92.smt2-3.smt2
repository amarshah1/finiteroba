...
(assert (not (forall ((ys!478 Lst!2392) (xs!477 Lst!2392)) (or (or (= (last!265 xs!477) (last!265 ys!478)) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) xs!477)) ) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) ys!478)) )) (= ys!478 nil!2396)) )))
(check-sat)
(exit)
