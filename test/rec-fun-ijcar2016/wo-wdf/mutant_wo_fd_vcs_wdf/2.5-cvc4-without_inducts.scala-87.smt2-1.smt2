...
(assert (not (forall ((n!458 Nat!2324) (xs!459 Lst!2328) (ys!460 Lst!2328)) (or (= (drop!257 n!458 xs!459) (append!252 (drop!257 n!458 xs!459) (drop!257 (minus!240 n!458 (len!254 (append!252 xs!459 ys!460))) ys!460))) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!458) (= (drop!257_arg_1_2 ?z) xs!459))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) (drop!257 n!458 xs!459)) (= (append!252_arg_1_4 ?z) (drop!257 (minus!240 n!458 (len!254 (append!252 xs!459 ys!460))) ys!460)))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!458) (= (drop!257_arg_1_2 ?z) xs!459))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) (minus!240 n!458 (len!254 (append!252 xs!459 ys!460)))) (= (drop!257_arg_1_2 ?z) ys!460))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_5 ?z) n!458) (= (minus!240_arg_1_6 ?z) (len!254 (append!252 xs!459 ys!460))))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_7 ?z) (append!252 xs!459 ys!460))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) xs!459) (= (append!252_arg_1_4 ?z) ys!460))) )) )))
(check-sat)
(exit)
