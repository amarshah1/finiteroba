...
(assert (not (forall ((xs!549 Lst!2641) (ys!550 Lst!2641) (zs!551 Lst!2641)) (or (= (zip!288 (append!252 xs!549 zs!551) ys!550) (zappend!291 (zip!288 xs!549 (take!260 (len!254 xs!549) zs!551)) (zip!288 ys!550 (drop!257 (len!254 xs!549) zs!551)))) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) (append!252 xs!549 zs!551)) (= (zip!288_arg_1_2 ?z) ys!550))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) xs!549) (= (append!252_arg_1_4 ?z) zs!551))) ) (forall ((?z I_zappend!291)) (not (and (= (zappend!291_arg_0_5 ?z) (zip!288 xs!549 (take!260 (len!254 xs!549) zs!551))) (= (zappend!291_arg_1_6 ?z) (zip!288 ys!550 (drop!257 (len!254 xs!549) zs!551))))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) xs!549) (= (zip!288_arg_1_2 ?z) (take!260 (len!254 xs!549) zs!551)))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_7 ?z) (len!254 xs!549)) (= (take!260_arg_1_8 ?z) zs!551))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_9 ?z) xs!549)) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) ys!550) (= (zip!288_arg_1_2 ?z) (drop!257 (len!254 xs!549) zs!551)))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_10 ?z) (len!254 xs!549)) (= (drop!257_arg_1_11 ?z) zs!551))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_9 ?z) xs!549)) )) )))
(check-sat)
(exit)
