...
(assert (not (forall ((BOUND_VARIABLE_606 Formula!922)) (or (not (and (isNNF!208 (lhs!929 (f!927 BOUND_VARIABLE_606))) (not (forall ((?z I_isNNF!208)) (not (= (isNNF!208_arg_0_1 ?z) (lhs!929 (f!927 BOUND_VARIABLE_606)))) )))) (or (isNNF!208 (ite ((_ is And!923) BOUND_VARIABLE_606) (Or!928 (nnf!206 (Not!926 (lhs!924 BOUND_VARIABLE_606))) (nnf!206 (Not!926 (rhs!925 BOUND_VARIABLE_606)))) (ite ((_ is Or!928) BOUND_VARIABLE_606) (And!923 (nnf!206 (Not!926 (lhs!929 BOUND_VARIABLE_606))) (nnf!206 (Not!926 (rhs!930 BOUND_VARIABLE_606)))) (ite ((_ is Not!926) BOUND_VARIABLE_606) (nnf!206 (f!927 BOUND_VARIABLE_606)) (Not!926 BOUND_VARIABLE_606))))) (forall ((?z I_isNNF!208)) (not (= (isNNF!208_arg_0_1 ?z) (ite ((_ is And!923) BOUND_VARIABLE_606) (Or!928 (nnf!206 (Not!926 (lhs!924 BOUND_VARIABLE_606))) (nnf!206 (Not!926 (rhs!925 BOUND_VARIABLE_606)))) (ite ((_ is Or!928) BOUND_VARIABLE_606) (And!923 (nnf!206 (Not!926 (lhs!929 BOUND_VARIABLE_606))) (nnf!206 (Not!926 (rhs!930 BOUND_VARIABLE_606)))) (ite ((_ is Not!926) BOUND_VARIABLE_606) (nnf!206 (f!927 BOUND_VARIABLE_606)) (Not!926 BOUND_VARIABLE_606)))))) ) (not (ite ((_ is And!923) BOUND_VARIABLE_606) (and (not (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Not!926 (lhs!924 BOUND_VARIABLE_606)))) )) (not (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Not!926 (rhs!925 BOUND_VARIABLE_606)))) ))) (ite ((_ is Or!928) BOUND_VARIABLE_606) (and (not (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Not!926 (lhs!929 BOUND_VARIABLE_606)))) )) (not (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (Not!926 (rhs!930 BOUND_VARIABLE_606)))) ))) (ite ((_ is Not!926) BOUND_VARIABLE_606) (not (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) (f!927 BOUND_VARIABLE_606))) )) true)))))) )))
(check-sat)
(exit)
