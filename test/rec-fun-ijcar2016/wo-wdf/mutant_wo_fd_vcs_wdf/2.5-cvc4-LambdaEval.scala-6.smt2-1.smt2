...
(assert (not (forall ((l!218 List!1133) (x!217 (_ BitVec 32))) (or (not (and (storeHasValues!213 (tail!1136 l!218)) (not (forall ((?z I_storeHasValues!213)) (not (= (storeHasValues!213_arg_0_3 ?z) (tail!1136 l!218))) )))) (not (and (contains!216 l!218 x!217) (not (forall ((?z I_contains!216)) (not (and (= (contains!216_arg_0_1 ?z) l!218) (= (contains!216_arg_1_2 ?z) x!217))) )))) (or (isValue!206 (ite ((_ is Cons!1134) l!218) (ite (= (key!1140 (head!1135 l!218)) x!217) (value!1141 (head!1135 l!218)) (find!219 x!217 l!218)) error_value!1167)) (forall ((?z I_isValue!206)) (not (= (isValue!206_arg_0_4 ?z) (ite ((_ is Cons!1134) l!218) (ite (= (key!1140 (head!1135 l!218)) x!217) (value!1141 (head!1135 l!218)) (find!219 x!217 l!218)) error_value!1167))) ) (not (ite ((_ is Cons!1134) l!218) (ite (= (key!1140 (head!1135 l!218)) x!217) true (not (forall ((?z I_find!219)) (not (and (= (find!219_arg_0_5 ?z) x!217) (= (find!219_arg_1_6 ?z) l!218))) ))) true)))) )))
(check-sat)
(exit)
