...
(assert (not (forall ((n!243 (_ BitVec 32))) (or (ite ((_ is None!1212) (min!214 (equals!239 n!243 Nil!1210))) (or (= (i!1214 (min!214 (equals!239 n!243 Nil!1210))) n!243) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 Nil!1210))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) Nil!1210))) )) (or (ite ((_ is Some!1213) (min!214 (equals!239 n!243 Nil!1210))) true error_value!1218) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 Nil!1210))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) Nil!1210))) ))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 Nil!1210))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) Nil!1210))) )) )))
(check-sat)
(exit)
