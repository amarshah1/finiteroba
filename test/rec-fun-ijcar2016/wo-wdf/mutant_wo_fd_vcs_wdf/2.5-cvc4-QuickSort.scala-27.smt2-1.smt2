...
(assert (not (forall ((e!247 (_ BitVec 32)) (n!246 (_ BitVec 32)) (BOUND_VARIABLE_366 (_ BitVec 32)) (BOUND_VARIABLE_367 List!1231)) (or (not (and (contains!209 (smaller!233 n!246 BOUND_VARIABLE_367) e!247) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (smaller!233 n!246 BOUND_VARIABLE_367)) (= (contains!209_arg_1_2 ?z) e!247))) )) (not (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_3 ?z) n!246) (= (smaller!233_arg_1_4 ?z) BOUND_VARIABLE_367))) )))) (or (contains!209 (smaller!233 n!246 (Cons!1232 BOUND_VARIABLE_366 BOUND_VARIABLE_367)) e!247) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (smaller!233 n!246 (Cons!1232 BOUND_VARIABLE_366 BOUND_VARIABLE_367))) (= (contains!209_arg_1_2 ?z) e!247))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_3 ?z) n!246) (= (smaller!233_arg_1_4 ?z) (Cons!1232 BOUND_VARIABLE_366 BOUND_VARIABLE_367)))) )) (not (bvslt e!247 n!246)) (not (and (contains!209 (Cons!1232 BOUND_VARIABLE_366 BOUND_VARIABLE_367) e!247) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (Cons!1232 BOUND_VARIABLE_366 BOUND_VARIABLE_367)) (= (contains!209_arg_1_2 ?z) e!247))) ))))) )))
(check-sat)
(exit)
