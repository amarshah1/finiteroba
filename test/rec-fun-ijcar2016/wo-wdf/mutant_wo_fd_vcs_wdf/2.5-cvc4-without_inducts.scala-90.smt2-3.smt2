...
(assert (not (forall ((n!470 Nat!2360) (xs!471 Lst!2364) (ys!472 Lst!2364)) (or (= (zdrop!294 n!470 (zip!288 (drop!257 n!470 xs!471) (drop!257 n!470 ys!472))) (zip!288 xs!471 ys!472)) (forall ((?z I_zdrop!294)) (not (and (= (zdrop!294_arg_0_1 ?z) n!470) (= (zdrop!294_arg_1_2 ?z) (zip!288 (drop!257 n!470 xs!471) (drop!257 n!470 ys!472))))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_3 ?z) (drop!257 n!470 xs!471)) (= (zip!288_arg_1_4 ?z) (drop!257 n!470 ys!472)))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_5 ?z) n!470) (= (drop!257_arg_1_6 ?z) xs!471))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_5 ?z) n!470) (= (drop!257_arg_1_6 ?z) ys!472))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_3 ?z) xs!471) (= (zip!288_arg_1_4 ?z) ys!472))) )) )))
(check-sat)
(exit)
