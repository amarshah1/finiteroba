...
(assert (not (forall ((n!228 (_ BitVec 32))) (or (ite ((_ is Some!1086) (min!214 (greater!227 (i!1087 (min!214 (greater!227 n!228 Nil!1083))) Nil!1083))) (bvslt n!228 n!228) (or (ite ((_ is None!1085) (min!214 (greater!227 n!228 Nil!1083))) true error_value!1091) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 n!228 Nil!1083))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) n!228) (= (greater!227_arg_1_3 ?z) Nil!1083))) ))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 (i!1087 (min!214 (greater!227 n!228 Nil!1083))) Nil!1083))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) (i!1087 (min!214 (greater!227 n!228 Nil!1083)))) (= (greater!227_arg_1_3 ?z) Nil!1083))) ) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 n!228 Nil!1083))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) n!228) (= (greater!227_arg_1_3 ?z) Nil!1083))) )) )))
(check-sat)
(exit)
