...
(assert (not (forall ((e!255 (_ BitVec 32)) (BOUND_VARIABLE_369 (_ BitVec 32)) (BOUND_VARIABLE_370 List!1259)) (or (not (and (contains!209 (equals!239 e!255 BOUND_VARIABLE_370) e!255) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (equals!239 e!255 BOUND_VARIABLE_370)) (= (contains!209_arg_1_2 ?z) e!255))) )) (not (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_3 ?z) e!255) (= (equals!239_arg_1_4 ?z) BOUND_VARIABLE_370))) )))) (or (contains!209 (equals!239 e!255 (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370)) e!255) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (equals!239 e!255 (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370))) (= (contains!209_arg_1_2 ?z) e!255))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_3 ?z) e!255) (= (equals!239_arg_1_4 ?z) (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370)))) )) (not (and (contains!209 (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370) e!255) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370)) (= (contains!209_arg_1_2 ?z) e!255))) ))))) )))
(check-sat)
(exit)
