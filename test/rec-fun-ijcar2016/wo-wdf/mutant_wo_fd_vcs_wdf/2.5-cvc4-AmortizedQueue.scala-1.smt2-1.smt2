...
(assert (not (forall ((list!205 List!961)) (or (>= (ite ((_ is Cons!962) list!205) 0 (ite ((_ is Nil!965) list!205) (+ 1 (size!206 (tail!964 list!205))) error_value!967)) 0) (not (ite ((_ is Cons!962) list!205) true (ite ((_ is Nil!965) list!205) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!964 list!205))) )) true)))) )))
(check-sat)
(exit)
