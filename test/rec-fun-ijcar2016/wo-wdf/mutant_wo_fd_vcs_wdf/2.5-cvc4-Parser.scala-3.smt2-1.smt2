...
(assert (not (forall ((l1!207 TokenList!969) (l2!208 TokenList!969)) (or (= (size!206 (ite ((_ is Nil!973) l1!207) l2!208 error_value!985)) (bvadd (size!206 l1!207) (size!206 l2!208))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (ite ((_ is Nil!973) l1!207) l2!208 error_value!985))) ) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l1!207)) ) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l2!208)) )) )))
(check-sat)
(exit)
