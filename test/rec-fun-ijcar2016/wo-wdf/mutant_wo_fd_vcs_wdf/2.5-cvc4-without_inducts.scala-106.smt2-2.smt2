...
(assert (not (forall ((n!520 Nat!2543) (h!521 Nat!2543) (x!522 Lst!2547)) (or (or (= (count!263 n!520 (append!252 (cons!2548 h!521 nil!2551) x!522)) (count!263 n!520 x!522)) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!520) (= (count!263_arg_1_2 ?z) (append!252 (cons!2548 h!521 nil!2551) x!522)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) (cons!2548 h!521 nil!2551)) (= (append!252_arg_1_4 ?z) x!522))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!520) (= (count!263_arg_1_2 ?z) x!522))) )) (= n!520 h!521)) )))
(check-sat)
(exit)
