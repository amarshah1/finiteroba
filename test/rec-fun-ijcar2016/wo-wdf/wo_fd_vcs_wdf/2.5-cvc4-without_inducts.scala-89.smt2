...
(assert (exists ((n!466 Nat!2348) (m!467 Nat!2348) (xs!468 Lst!2352)) (not (or (= (drop!257 n!466 (take!260 m!467 xs!468)) (take!260 (minus!240 m!467 n!466) (drop!257 n!466 xs!468))) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!466) (= (drop!257_arg_1_2 ?z) (take!260 m!467 xs!468)))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_3 ?z) m!467) (= (take!260_arg_1_4 ?z) xs!468))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_3 ?z) (minus!240 m!467 n!466)) (= (take!260_arg_1_4 ?z) (drop!257 n!466 xs!468)))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_5 ?z) m!467) (= (minus!240_arg_1_6 ?z) n!466))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_1 ?z) n!466) (= (drop!257_arg_1_2 ?z) xs!468))) ))) ))
(check-sat)
(exit)
