...
(assert (exists ((f!221 Formula!1368)) (not (=> (and (and (and ((_ is Not!1377) f!221) ((_ is Not!1377) f!221)) (and (isSimplified!208 f!221) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) f!221)) )))) (=> (or (isSimplified!208 (f!1378 f!221)) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (f!1378 f!221))) )) (and (= (simplify!206 (f!1378 f!221)) (f!1378 f!221)) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (f!1378 f!221))) ))))) (or (= (simplify!206 f!221) f!221) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) f!221)) )))) ))
(check-sat)
(exit)
