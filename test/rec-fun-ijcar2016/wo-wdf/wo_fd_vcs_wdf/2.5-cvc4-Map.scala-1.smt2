...
(assert (exists ((l!205 List!883) (f!206 (Array T!204 T!204))) (not (or (= (List$map!899 l!205 f!206) (List$map!899 (List$map!899 l!205 f!206) f!206)) (forall ((?z I_List$map!899)) (not (and (= (List$map!899_arg_0_1 ?z) l!205) (= (List$map!899_arg_1_2 ?z) f!206))) ) (forall ((?z I_List$map!899)) (not (and (= (List$map!899_arg_0_1 ?z) (List$map!899 l!205 f!206)) (= (List$map!899_arg_1_2 ?z) f!206))) ) (forall ((?z I_List$map!899)) (not (and (= (List$map!899_arg_0_1 ?z) l!205) (= (List$map!899_arg_1_2 ?z) f!206))) ))) ))
(check-sat)
(exit)
