...
(assert (exists ((l!205 List!955)) (not (or (bvsge (ite ((_ is Nil!959) l!205) (_ bv0 32) (ite ((_ is Cons!956) l!205) (bvadd (_ bv1 32) (size!206 (tail!958 l!205))) error_value!961)) (_ bv0 32)) (not (ite ((_ is Nil!959) l!205) true (ite ((_ is Cons!956) l!205) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!958 l!205))) )) true))))) ))
(check-sat)
(exit)
