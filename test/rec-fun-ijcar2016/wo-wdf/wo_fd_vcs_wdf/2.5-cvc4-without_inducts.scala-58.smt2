...
(assert (exists ((a!373 Nat!2017) (b!374 Nat!2017)) (not (or (= (= (nmax!246 a!373 b!374) b!374) (leq!234 a!373 b!374)) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) a!373) (= (nmax!246_arg_1_2 ?z) b!374))) ) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_5 ?z) a!373) (= (leq!234_arg_1_6 ?z) b!374))) ))) ))
(check-sat)
(exit)
