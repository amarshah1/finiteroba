...
(assert (exists ((xs!557 Lst!2689) (ys!558 Lst!2689)) (not (or (or (not (and (= (len!254 xs!557) (len!254 ys!558)) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) xs!557)) )) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) ys!558)) )))) (not (and (= (len!254 xs!557) (len!254 ys!558)) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) xs!557)) )) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) ys!558)) ))))) (or (= (zip!288 (rev!275 xs!557) (rev!275 ys!558)) (zrev!299 (zip!288 xs!557 ys!558))) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_2 ?z) (rev!275 xs!557)) (= (zip!288_arg_1_3 ?z) (rev!275 ys!558)))) ) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_4 ?z) xs!557)) ) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_4 ?z) ys!558)) ) (forall ((?z I_zrev!299)) (not (= (zrev!299_arg_0_7 ?z) (zip!288 xs!557 ys!558))) ) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_2 ?z) xs!557) (= (zip!288_arg_1_3 ?z) ys!558))) )))) ))
(check-sat)
(exit)
