...
(assert (exists ((x!212 Nat!920) (y!213 Nat!920) (z!214 Nat!920)) (not (=> (and (and ((_ is Succ!921) x!212) ((_ is Succ!921) x!212)) (and (= (plus!207 (x!922 x!212) (plus!207 y!213 z!214)) (plus!207 (plus!207 (x!922 x!212) y!213) z!214)) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (x!922 x!212)) (= (plus!207_arg_1_2 ?z) (plus!207 y!213 z!214)))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!213) (= (plus!207_arg_1_2 ?z) z!214))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (plus!207 (x!922 x!212) y!213)) (= (plus!207_arg_1_2 ?z) z!214))) )) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (x!922 x!212)) (= (plus!207_arg_1_2 ?z) y!213))) )))) (or (= (plus!207 x!212 (plus!207 y!213 z!214)) (plus!207 (plus!207 x!212 y!213) z!214)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) x!212) (= (plus!207_arg_1_2 ?z) (plus!207 y!213 z!214)))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!213) (= (plus!207_arg_1_2 ?z) z!214))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (plus!207 x!212 y!213)) (= (plus!207_arg_1_2 ?z) z!214))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) x!212) (= (plus!207_arg_1_2 ?z) y!213))) )))) ))
(check-sat)
(exit)
