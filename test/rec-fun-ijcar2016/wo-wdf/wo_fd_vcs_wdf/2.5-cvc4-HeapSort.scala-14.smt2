...
(assert (exists ((heap!221 Heap!1069) (element!220 (_ BitVec 32))) (not (=> (and (hasLeftistProperty!210 heap!221) (not (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) heap!221)) ))) (or (= (heapSize!212 (merge!215 (Node!1071 (_ bv1 32) element!220 Leaf!1070 Leaf!1070) heap!221)) (bvadd (heapSize!212 heap!221) (_ bv1 32))) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) (merge!215 (Node!1071 (_ bv1 32) element!220 Leaf!1070 Leaf!1070) heap!221))) ) (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_8 ?z) (Node!1071 (_ bv1 32) element!220 Leaf!1070 Leaf!1070)) (= (merge!215_arg_1_9 ?z) heap!221))) ) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) heap!221)) )))) ))
(check-sat)
(exit)
