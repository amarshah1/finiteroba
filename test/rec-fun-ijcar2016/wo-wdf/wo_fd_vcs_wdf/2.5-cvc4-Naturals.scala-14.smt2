...
(assert (exists ((x!224 Nat!965) (y!225 Nat!965)) (not (=> ((_ is Zero!968) x!224) (or (= (plus!207 x!224 y!225) (plus!207 y!225 x!224)) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) x!224) (= (plus!207_arg_1_2 ?z) y!225))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!225) (= (plus!207_arg_1_2 ?z) x!224))) )))) ))
(check-sat)
(exit)
