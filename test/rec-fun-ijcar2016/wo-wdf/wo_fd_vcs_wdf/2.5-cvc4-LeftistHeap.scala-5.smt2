...
(assert (exists ((h!211 Heap!937)) (not (=> (and (hasLeftistProperty!208 h!211) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) h!211)) ))) (or (bvsge (size!210 (ite ((_ is Node!939) h!211) (merge!215 (left!942 h!211) (right!943 h!211)) (ite ((_ is Leaf!938) h!211) h!211 error_value!949))) (bvsub (size!210 h!211) (_ bv1 32))) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) (ite ((_ is Node!939) h!211) (merge!215 (left!942 h!211) (right!943 h!211)) (ite ((_ is Leaf!938) h!211) h!211 error_value!949)))) ) (not (ite ((_ is Node!939) h!211) (not (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_7 ?z) (left!942 h!211)) (= (merge!215_arg_1_8 ?z) (right!943 h!211)))) )) true)) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) h!211)) )))) ))
(check-sat)
(exit)
