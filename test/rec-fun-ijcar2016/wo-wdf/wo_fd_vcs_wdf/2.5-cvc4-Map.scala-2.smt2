...
(assert (exists ((l!209 List!947) (f!210 (Array T!208 T!208))) (not (or (= (List$map!963 l!209 f!210) (ite ((_ is Cons!948) l!209) (Cons!948 (h!949 l!209) (List$map!963 (t!950 l!209) f!210)) (ite ((_ is Nil!951) l!209) Nil!951 error_value!1000))) (forall ((?z I_List$map!963)) (not (and (= (List$map!963_arg_0_1 ?z) l!209) (= (List$map!963_arg_1_2 ?z) f!210))) ) (not (ite ((_ is Cons!948) l!209) (not (forall ((?z I_List$map!963)) (not (and (= (List$map!963_arg_0_1 ?z) (t!950 l!209)) (= (List$map!963_arg_1_2 ?z) f!210))) )) true)))) ))
(check-sat)
(exit)
