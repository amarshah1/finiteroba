...
(assert (not (or (= (isBitNSet!213 (_ bv4294967263 32) (_ bv5 32)) (_ bv0 32)) (forall ((?z I_isBitNSet!213)) (not (and (= (isBitNSet!213_arg_0_1 ?z) (_ bv4294967263 32)) (= (isBitNSet!213_arg_1_2 ?z) (_ bv5 32)))) ))))
(check-sat)
(exit)
