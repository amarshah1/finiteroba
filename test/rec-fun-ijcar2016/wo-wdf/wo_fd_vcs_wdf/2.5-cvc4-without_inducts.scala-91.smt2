...
(assert (exists ((ys!475 Lst!2381) (xs!474 Lst!2381)) (not (or (or (not (= ys!475 nil!2385)) (not (= ys!475 nil!2385))) (or (= (last!265 (append!252 xs!474 ys!475)) (last!265 xs!474)) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) (append!252 xs!474 ys!475))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!474) (= (append!252_arg_1_3 ?z) ys!475))) ) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) xs!474)) )))) ))
(check-sat)
(exit)
