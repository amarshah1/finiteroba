...
(assert (exists ((x!406 Nat!2098) (l!407 Lst!2102)) (not (not (and (mem!270 x!406 (delete!273 x!406 l!407)) (not (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!406) (= (mem!270_arg_1_2 ?z) (delete!273 x!406 l!407)))) )) (not (forall ((?z I_delete!273)) (not (and (= (delete!273_arg_0_3 ?z) x!406) (= (delete!273_arg_1_4 ?z) l!407))) ))))) ))
(check-sat)
(exit)
