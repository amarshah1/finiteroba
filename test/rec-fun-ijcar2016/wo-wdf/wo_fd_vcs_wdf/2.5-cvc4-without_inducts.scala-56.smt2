...
(assert (exists ((a!367 Nat!2007) (b!368 Nat!2007)) (not (or (= (nmax!246 a!367 b!368) (nmax!246 b!368 a!367)) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) a!367) (= (nmax!246_arg_1_2 ?z) b!368))) ) (forall ((?z I_nmax!246)) (not (and (= (nmax!246_arg_0_1 ?z) b!368) (= (nmax!246_arg_1_2 ?z) a!367))) ))) ))
(check-sat)
(exit)
