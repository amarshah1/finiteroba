...
(assert (exists ((i!352 Nat!1965) (m!353 Nat!1965)) (not (or (less!231 i!352 (succ!1966 (plus!237 i!352 m!353))) (forall ((?z I_less!231)) (not (and (= (less!231_arg_0_1 ?z) i!352) (= (less!231_arg_1_2 ?z) (succ!1966 (plus!237 i!352 m!353))))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) i!352) (= (plus!237_arg_1_4 ?z) m!353))) ))) ))
(check-sat)
(exit)
