...
(assert (exists ((t!241 Tree!1170)) (not (=> (and (isBST!232 t!241) (not (forall ((?z I_isBST!232)) (not (= (isBST!232_arg_0_10 ?z) t!241)) ))) (or (= (ite ((_ is Leaf!1171) t!241) None!1178 (ite (and (and ((_ is Node!1172) t!241) ((_ is Node!1172) t!241)) ((_ is Leaf!1171) (left!1173 t!241))) (Some!1179 (value!1174 t!241)) (ite ((_ is Node!1172) t!241) (bstMin!242 (left!1173 t!241)) error_value!1186))) (treeMin!230 t!241)) (not (ite ((_ is Leaf!1171) t!241) true (ite (and (and ((_ is Node!1172) t!241) ((_ is Node!1172) t!241)) ((_ is Leaf!1171) (left!1173 t!241))) true (ite ((_ is Node!1172) t!241) (not (forall ((?z I_bstMin!242)) (not (= (bstMin!242_arg_0_4 ?z) (left!1173 t!241))) )) true)))) (forall ((?z I_treeMin!230)) (not (= (treeMin!230_arg_0_11 ?z) t!241)) )))) ))
(check-sat)
(exit)
