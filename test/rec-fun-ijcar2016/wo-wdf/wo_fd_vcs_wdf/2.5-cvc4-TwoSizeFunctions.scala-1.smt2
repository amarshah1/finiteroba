...
(assert (exists ((l!205 List!882)) (not (or (>= (ite ((_ is Cons!883) l!205) (+ (size1!206 (tail!885 l!205)) 1) (ite ((_ is Nil!886) l!205) (- 0) error_value!888)) (- 0)) (not (ite ((_ is Cons!883) l!205) (not (forall ((?z I_size1!206)) (not (= (size1!206_arg_0_1 ?z) (tail!885 l!205))) )) true)))) ))
(check-sat)
(exit)
