...
(assert (exists ((list!241 List!1167) (n!240 (_ BitVec 32))) (not (=> ((_ is Nil!1171) list!241) (or (ite ((_ is Some!1174) (max!216 (equals!239 n!240 list!241))) (or (= n!240 (i!1175 (max!216 (equals!239 n!240 list!241)))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 list!241))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) list!241))) )) (or (ite ((_ is None!1173) (max!216 (equals!239 n!240 list!241))) true error_value!1179) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 list!241))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) list!241))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (equals!239 n!240 list!241))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!240) (= (equals!239_arg_1_3 ?z) list!241))) )))) ))
(check-sat)
(exit)
