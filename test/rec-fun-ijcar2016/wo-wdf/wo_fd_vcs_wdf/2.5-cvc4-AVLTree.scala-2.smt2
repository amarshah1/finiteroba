...
(assert (exists ((t!223 Tree!1015)) (not (or (bvsge (ite ((_ is Leaf!1016) t!223) (_ bv0 32) (ite ((_ is Node!1017) t!223) (bvadd (bvadd (size!224 (left!1018 t!223)) (_ bv1 32)) (size!224 (right!1020 t!223))) error_value!1023)) (_ bv0 32)) (not (ite ((_ is Leaf!1016) t!223) true (ite ((_ is Node!1017) t!223) (and (not (forall ((?z I_size!224)) (not (= (size!224_arg_0_1 ?z) (left!1018 t!223))) )) (not (forall ((?z I_size!224)) (not (= (size!224_arg_0_1 ?z) (right!1020 t!223))) ))) true))))) ))
(check-sat)
(exit)
