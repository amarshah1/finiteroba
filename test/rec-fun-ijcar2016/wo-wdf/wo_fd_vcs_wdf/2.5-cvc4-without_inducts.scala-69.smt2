...
(assert (exists ((n!409 Nat!2109) (x!410 Lst!2113)) (not (or (= (count!263 n!409 (append!252 x!410 (cons!2114 n!409 nil!2117))) (succ!2110 (count!263 n!409 x!410))) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!409) (= (count!263_arg_1_2 ?z) (append!252 x!410 (cons!2114 n!409 nil!2117))))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) x!410) (= (append!252_arg_1_4 ?z) (cons!2114 n!409 nil!2117)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!409) (= (count!263_arg_1_2 ?z) x!410))) ))) ))
(check-sat)
(exit)
