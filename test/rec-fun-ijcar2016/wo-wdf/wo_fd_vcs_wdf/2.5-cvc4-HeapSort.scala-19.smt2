...
(assert (exists ((l!228 List!1122)) (not (or (bvsge (ite ((_ is Nil!1126) l!228) (_ bv0 32) (ite ((_ is Cons!1123) l!228) (bvadd (_ bv1 32) (listSize!229 (tail!1125 l!228))) error_value!1128)) (_ bv0 32)) (not (ite ((_ is Nil!1126) l!228) true (ite ((_ is Cons!1123) l!228) (not (forall ((?z I_listSize!229)) (not (= (listSize!229_arg_0_1 ?z) (tail!1125 l!228))) )) true))))) ))
(check-sat)
(exit)
