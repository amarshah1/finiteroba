...
(assert (exists ((l!358 Lst!1983)) (not (or (= (len!254 (sort!285 l!358)) (len!254 l!358)) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) (sort!285 l!358))) ) (forall ((?z I_sort!285)) (not (= (sort!285_arg_0_2 ?z) l!358)) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_1 ?z) l!358)) ))) ))
(check-sat)
(exit)
