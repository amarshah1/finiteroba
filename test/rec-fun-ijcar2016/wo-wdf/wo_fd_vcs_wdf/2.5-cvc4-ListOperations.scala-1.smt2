...
(assert (exists ((l!205 List!974)) (not (or (>= (ite ((_ is Nil!978) l!205) (- 0) (ite ((_ is Cons!975) l!205) (+ 1 (size!206 (tail!977 l!205))) error_value!980)) (- 0)) (not (ite ((_ is Nil!978) l!205) true (ite ((_ is Cons!975) l!205) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!977 l!205))) )) true))))) ))
(check-sat)
(exit)
