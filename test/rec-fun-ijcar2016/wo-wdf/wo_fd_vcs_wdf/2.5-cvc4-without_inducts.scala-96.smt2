...
(assert (exists ((xs!490 Lst!2437) (x!489 Nat!2442)) (not (or (= (last!265 (append!252 xs!490 (cons!2438 x!489 nil!2441))) x!489) (forall ((?z I_last!265)) (not (= (last!265_arg_0_1 ?z) (append!252 xs!490 (cons!2438 x!489 nil!2441)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!490) (= (append!252_arg_1_3 ?z) (cons!2438 x!489 nil!2441)))) ))) ))
(check-sat)
(exit)
