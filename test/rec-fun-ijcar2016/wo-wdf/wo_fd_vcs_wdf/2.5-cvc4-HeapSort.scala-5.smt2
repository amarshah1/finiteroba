...
(assert (exists ((t!211 Heap!972)) (not (=> (and (hasLeftistProperty!210 t!211) (not (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) t!211)) ))) (or (bvsge (ite ((_ is Leaf!973) t!211) (_ bv0 32) (ite ((_ is Node!974) t!211) (bvadd (bvadd (heapSize!212 (left!977 t!211)) (_ bv1 32)) (heapSize!212 (right!978 t!211))) error_value!983)) (_ bv0 32)) (not (ite ((_ is Leaf!973) t!211) true (ite ((_ is Node!974) t!211) (and (not (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) (left!977 t!211))) )) (not (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_4 ?z) (right!978 t!211))) ))) true)))))) ))
(check-sat)
(exit)
