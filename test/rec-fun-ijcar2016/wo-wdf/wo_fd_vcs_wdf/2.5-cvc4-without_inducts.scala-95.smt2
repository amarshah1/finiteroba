...
(assert (exists ((n!486 Nat!2424) (xs!487 Lst!2428)) (not (or (or (not (and (less!231 n!486 (len!254 xs!487)) (not (forall ((?z I_less!231)) (not (and (= (less!231_arg_0_1 ?z) n!486) (= (less!231_arg_1_2 ?z) (len!254 xs!487)))) )) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_3 ?z) xs!487)) )))) (not (and (less!231 n!486 (len!254 xs!487)) (not (forall ((?z I_less!231)) (not (and (= (less!231_arg_0_1 ?z) n!486) (= (less!231_arg_1_2 ?z) (len!254 xs!487)))) )) (not (forall ((?z I_len!254)) (not (= (len!254_arg_0_3 ?z) xs!487)) ))))) (or (= (last!265 (drop!257 n!486 xs!487)) (last!265 xs!487)) (forall ((?z I_last!265)) (not (= (last!265_arg_0_4 ?z) (drop!257 n!486 xs!487))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_5 ?z) n!486) (= (drop!257_arg_1_6 ?z) xs!487))) ) (forall ((?z I_last!265)) (not (= (last!265_arg_0_4 ?z) xs!487)) )))) ))
(check-sat)
(exit)
