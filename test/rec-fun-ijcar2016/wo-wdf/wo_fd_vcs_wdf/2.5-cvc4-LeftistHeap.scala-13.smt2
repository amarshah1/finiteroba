...
(assert (exists ((heap!221 Heap!1018) (element!220 (_ BitVec 32))) (not (=> (and (hasLeftistProperty!208 heap!221) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) heap!221)) ))) (or (= (size!210 (merge!215 (Node!1020 (_ bv1 32) element!220 Leaf!1019 Leaf!1019) heap!221)) (bvadd (size!210 heap!221) (_ bv1 32))) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) (merge!215 (Node!1020 (_ bv1 32) element!220 Leaf!1019 Leaf!1019) heap!221))) ) (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_7 ?z) (Node!1020 (_ bv1 32) element!220 Leaf!1019 Leaf!1019)) (= (merge!215_arg_1_8 ?z) heap!221))) ) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) heap!221)) )))) ))
(check-sat)
(exit)
