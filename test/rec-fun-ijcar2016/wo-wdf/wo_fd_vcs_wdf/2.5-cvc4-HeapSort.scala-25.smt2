...
(assert (exists ((h!234 Heap!1189) (l!233 List!1196)) (not (=> (and (hasLeftistProperty!210 h!234) (not (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) h!234)) ))) (and (and (or (hasLeftistProperty!210 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209))) (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209)))) ) (not (ite ((_ is Nil!1200) l!233) true (ite ((_ is Cons!1197) l!233) (and (not (forall ((?z I_buildHeap!235)) (not (and (= (buildHeap!235_arg_0_11 ?z) (tail!1199 l!233)) (= (buildHeap!235_arg_1_12 ?z) (insert!222 (head!1198 l!233) h!234)))) )) (not (forall ((?z I_insert!222)) (not (and (= (insert!222_arg_0_4 ?z) (head!1198 l!233)) (= (insert!222_arg_1_5 ?z) h!234))) ))) true)))) (or (hasLeftistProperty!210 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209))) (forall ((?z I_hasLeftistProperty!210)) (not (= (hasLeftistProperty!210_arg_0_1 ?z) (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209)))) ) (not (ite ((_ is Nil!1200) l!233) true (ite ((_ is Cons!1197) l!233) (and (not (forall ((?z I_buildHeap!235)) (not (and (= (buildHeap!235_arg_0_11 ?z) (tail!1199 l!233)) (= (buildHeap!235_arg_1_12 ?z) (insert!222 (head!1198 l!233) h!234)))) )) (not (forall ((?z I_insert!222)) (not (and (= (insert!222_arg_0_4 ?z) (head!1198 l!233)) (= (insert!222_arg_1_5 ?z) h!234))) ))) true))))) (or (= (bvadd (heapSize!212 h!234) (listSize!229 l!233)) (heapSize!212 (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209)))) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_6 ?z) h!234)) ) (forall ((?z I_listSize!229)) (not (= (listSize!229_arg_0_7 ?z) l!233)) ) (forall ((?z I_heapSize!212)) (not (= (heapSize!212_arg_0_6 ?z) (ite ((_ is Nil!1200) l!233) h!234 (ite ((_ is Cons!1197) l!233) (buildHeap!235 (tail!1199 l!233) (insert!222 (head!1198 l!233) h!234)) error_value!1209)))) ) (not (ite ((_ is Nil!1200) l!233) true (ite ((_ is Cons!1197) l!233) (and (not (forall ((?z I_buildHeap!235)) (not (and (= (buildHeap!235_arg_0_11 ?z) (tail!1199 l!233)) (= (buildHeap!235_arg_1_12 ?z) (insert!222 (head!1198 l!233) h!234)))) )) (not (forall ((?z I_insert!222)) (not (and (= (insert!222_arg_0_4 ?z) (head!1198 l!233)) (= (insert!222_arg_1_5 ?z) h!234))) ))) true))))))) ))
(check-sat)
(exit)
