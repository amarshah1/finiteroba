...
(assert (exists ((x!497 Nat!2466) (l!498 Lst!2470)) (not (or (leq!234 (len!254 (delete!273 x!497 l!498)) (len!254 l!498)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) (len!254 (delete!273 x!497 l!498))) (= (leq!234_arg_1_2 ?z) (len!254 l!498)))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_5 ?z) (delete!273 x!497 l!498))) ) (forall ((?z I_delete!273)) (not (and (= (delete!273_arg_0_6 ?z) x!497) (= (delete!273_arg_1_7 ?z) l!498))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_5 ?z) l!498)) ))) ))
(check-sat)
(exit)
