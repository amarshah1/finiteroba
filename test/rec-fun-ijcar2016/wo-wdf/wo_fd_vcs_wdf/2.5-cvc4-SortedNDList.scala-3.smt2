...
(assert (exists ((list!207 SortedNDList!896) (node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32))) (not (=> (and (and (and (and (and ((_ is ListNode!898) list!207) ((_ is ListNode!898) list!207)) (and (sndInvariant!206 list!207) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) list!207)) )))) (bvsge node!208 (_ bv0 32))) (bvsge dist!209 (_ bv0 32))) (=> (and (and (and (or (sndInvariant!206 (next!901 list!207)) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (next!901 list!207))) )) (or (sndInvariant!206 (next!901 list!207)) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (next!901 list!207))) ))) (bvsge node!208 (_ bv0 32))) (bvsge dist!209 (_ bv0 32))) (and (sndInvariant!206 (ListNode!898 node!208 dist!209 (next!901 list!207))) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!898 node!208 dist!209 (next!901 list!207)))) ))))) (or (sndInvariant!206 (ListNode!898 node!208 dist!209 list!207)) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!898 node!208 dist!209 list!207))) )))) ))
(check-sat)
(exit)
