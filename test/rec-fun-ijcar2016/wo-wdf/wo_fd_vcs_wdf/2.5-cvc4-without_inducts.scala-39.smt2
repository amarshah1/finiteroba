...
(assert (exists ((n!315 Nat!1867) (l!316 Lst!1871)) (not (or (= (plus!237 (succ!1868 zero!1870) (count!263 n!315 l!316)) (count!263 n!315 (cons!1872 n!315 l!316))) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_1 ?z) (succ!1868 zero!1870)) (= (plus!237_arg_1_2 ?z) (count!263 n!315 l!316)))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!315) (= (count!263_arg_1_4 ?z) l!316))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_3 ?z) n!315) (= (count!263_arg_1_4 ?z) (cons!1872 n!315 l!316)))) ))) ))
(check-sat)
(exit)
