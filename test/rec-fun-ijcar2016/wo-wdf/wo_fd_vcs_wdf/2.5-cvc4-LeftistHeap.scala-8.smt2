...
(assert (exists ((h1!213 Heap!968) (h2!214 Heap!968)) (not (=> (and (and (and (hasLeftistProperty!208 h1!213) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) h1!213)) ))) (and (hasLeftistProperty!208 h1!213) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) h1!213)) )))) (and (hasLeftistProperty!208 h2!214) (not (forall ((?z I_hasLeftistProperty!208)) (not (= (hasLeftistProperty!208_arg_0_1 ?z) h2!214)) )))) (or (= (size!210 (ite ((_ is Leaf!969) h1!213) h2!214 (ite ((_ is Node!970) h1!213) (ite ((_ is Leaf!969) h2!214) h1!213 (ite ((_ is Node!970) h2!214) (ite (bvsgt (value!972 h1!213) (value!972 h2!214)) (makeT!219 (value!972 h1!213) (left!973 h1!213) (merge!215 (right!974 h1!213) h2!214)) (makeT!219 (value!972 h2!214) (left!973 h2!214) (merge!215 h1!213 (right!974 h2!214)))) error_value!980)) error_value!981))) (bvadd (size!210 h1!213) (size!210 h2!214))) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) (ite ((_ is Leaf!969) h1!213) h2!214 (ite ((_ is Node!970) h1!213) (ite ((_ is Leaf!969) h2!214) h1!213 (ite ((_ is Node!970) h2!214) (ite (bvsgt (value!972 h1!213) (value!972 h2!214)) (makeT!219 (value!972 h1!213) (left!973 h1!213) (merge!215 (right!974 h1!213) h2!214)) (makeT!219 (value!972 h2!214) (left!973 h2!214) (merge!215 h1!213 (right!974 h2!214)))) error_value!980)) error_value!981)))) ) (not (ite ((_ is Leaf!969) h1!213) true (ite ((_ is Node!970) h1!213) (ite ((_ is Leaf!969) h2!214) true (ite ((_ is Node!970) h2!214) (ite (bvsgt (value!972 h1!213) (value!972 h2!214)) (and (not (forall ((?z I_makeT!219)) (not (and (= (makeT!219_arg_0_4 ?z) (value!972 h1!213)) (= (makeT!219_arg_1_5 ?z) (left!973 h1!213)) (= (makeT!219_arg_2_6 ?z) (merge!215 (right!974 h1!213) h2!214)))) )) (not (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_7 ?z) (right!974 h1!213)) (= (merge!215_arg_1_8 ?z) h2!214))) ))) (and (not (forall ((?z I_makeT!219)) (not (and (= (makeT!219_arg_0_4 ?z) (value!972 h2!214)) (= (makeT!219_arg_1_5 ?z) (left!973 h2!214)) (= (makeT!219_arg_2_6 ?z) (merge!215 h1!213 (right!974 h2!214))))) )) (not (forall ((?z I_merge!215)) (not (and (= (merge!215_arg_0_7 ?z) h1!213) (= (merge!215_arg_1_8 ?z) (right!974 h2!214)))) )))) true)) true))) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) h1!213)) ) (forall ((?z I_size!210)) (not (= (size!210_arg_0_3 ?z) h2!214)) )))) ))
(check-sat)
(exit)
