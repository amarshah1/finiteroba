...
(assert (not (not (and (= (isBitNSet!213 (_ bv122 32) (_ bv3 32)) (_ bv0 32)) (not (forall ((?z I_isBitNSet!213)) (not (and (= (isBitNSet!213_arg_0_1 ?z) (_ bv122 32)) (= (isBitNSet!213_arg_1_2 ?z) (_ bv3 32)))) ))))))
(check-sat)
(exit)
