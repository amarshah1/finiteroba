...
(assert (exists ((x!376 Nat!2022) (l!377 Lst!2026) (t!378 Lst!2026)) (not (or (or (not (and (mem!270 x!376 l!377) (not (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!376) (= (mem!270_arg_1_2 ?z) l!377))) )))) (not (and (mem!270 x!376 l!377) (not (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!376) (= (mem!270_arg_1_2 ?z) l!377))) ))))) (or (mem!270 x!376 (append!252 l!377 t!378)) (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!376) (= (mem!270_arg_1_2 ?z) (append!252 l!377 t!378)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_3 ?z) l!377) (= (append!252_arg_1_4 ?z) t!378))) )))) ))
(check-sat)
(exit)
