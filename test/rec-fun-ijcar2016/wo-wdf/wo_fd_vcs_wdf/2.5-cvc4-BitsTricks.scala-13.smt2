...
(assert (exists ((x!228 (_ BitVec 32))) (not (or (= (bvand x!228 (bvsub x!228 (_ bv1 32))) (turnOffRightmostOneRec!227 x!228 (_ bv0 32))) (forall ((?z I_turnOffRightmostOneRec!227)) (not (and (= (turnOffRightmostOneRec!227_arg_0_1 ?z) x!228) (= (turnOffRightmostOneRec!227_arg_1_2 ?z) (_ bv0 32)))) ))) ))
(check-sat)
(exit)
