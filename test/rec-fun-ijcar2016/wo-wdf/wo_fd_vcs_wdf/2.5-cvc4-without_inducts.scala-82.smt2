...
(assert (exists ((xs!442 Lst!2277) (x!443 Nat!2282)) (not (or (= (butlast!267 (append!252 xs!442 (cons!2278 x!443 nil!2281))) xs!442) (forall ((?z I_butlast!267)) (not (= (butlast!267_arg_0_1 ?z) (append!252 xs!442 (cons!2278 x!443 nil!2281)))) ) (forall ((?z I_append!252)) (not (and (= (append!252_arg_0_2 ?z) xs!442) (= (append!252_arg_1_3 ?z) (cons!2278 x!443 nil!2281)))) ))) ))
(check-sat)
(exit)
