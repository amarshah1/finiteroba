...
(assert (exists ((n!418 Nat!2141) (x!419 Nat!2141) (xs!420 Lst!2145)) (not (or (= (take!260 (succ!2142 n!418) (cons!2146 x!419 xs!420)) (cons!2146 x!419 (take!260 n!418 xs!420))) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) (succ!2142 n!418)) (= (take!260_arg_1_2 ?z) (cons!2146 x!419 xs!420)))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_1 ?z) n!418) (= (take!260_arg_1_2 ?z) xs!420))) ))) ))
(check-sat)
(exit)
