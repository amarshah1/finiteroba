...
(assert (exists ((m!451 Nat!2313) (n!452 Nat!2313)) (not (or (= (minus!240 (plus!237 m!451 n!452) n!452) m!451) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (plus!237 m!451 n!452)) (= (minus!240_arg_1_2 ?z) n!452))) ) (forall ((?z I_plus!237)) (not (and (= (plus!237_arg_0_3 ?z) m!451) (= (plus!237_arg_1_4 ?z) n!452))) ))) ))
(check-sat)
(exit)
