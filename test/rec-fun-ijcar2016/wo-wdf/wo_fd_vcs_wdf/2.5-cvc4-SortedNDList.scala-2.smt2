...
(assert (exists ((list!207 SortedNDList!889) (node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32))) (not (=> (and (and (and (and ((_ is ListEnd!890) list!207) ((_ is ListEnd!890) list!207)) (and (sndInvariant!206 list!207) (not (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) list!207)) )))) (bvsge node!208 (_ bv0 32))) (bvsge dist!209 (_ bv0 32))) (or (sndInvariant!206 (ListNode!891 node!208 dist!209 list!207)) (forall ((?z I_sndInvariant!206)) (not (= (sndInvariant!206_arg_0_1 ?z) (ListNode!891 node!208 dist!209 list!207))) )))) ))
(check-sat)
(exit)
