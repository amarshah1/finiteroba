...
(assert (exists ((f!211 Formula!1107)) (not (=> ((_ is Variable!1116) f!211) (or (= (eval!210 f!211) (eval!210 (nnf!206 f!211))) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) f!211)) ) (forall ((?z I_eval!210)) (not (= (eval!210_arg_0_1 ?z) (nnf!206 f!211))) ) (forall ((?z I_nnf!206)) (not (= (nnf!206_arg_0_2 ?z) f!211)) )))) ))
(check-sat)
(exit)
