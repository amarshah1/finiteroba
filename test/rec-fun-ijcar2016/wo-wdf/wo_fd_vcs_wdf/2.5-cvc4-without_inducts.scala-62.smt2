...
(assert (exists ((x!387 Nat!2055) (l!388 Lst!2059)) (not (or (mem!270 x!387 (ins1!278 x!387 l!388)) (forall ((?z I_mem!270)) (not (and (= (mem!270_arg_0_1 ?z) x!387) (= (mem!270_arg_1_2 ?z) (ins1!278 x!387 l!388)))) ) (forall ((?z I_ins1!278)) (not (and (= (ins1!278_arg_0_3 ?z) x!387) (= (ins1!278_arg_1_4 ?z) l!388))) ))) ))
(check-sat)
(exit)
