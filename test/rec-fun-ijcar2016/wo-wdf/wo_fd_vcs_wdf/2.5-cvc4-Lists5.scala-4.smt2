...
(assert (exists ((list!220 List!930) (f!219 (Array T!218 Bool))) (not (ite ((_ is Cons!931) list!220) (and (and (or (equivalence_lemma!946 f!219 list!220) (forall ((?z I_equivalence_lemma!946)) (not (and (= (equivalence_lemma!946_arg_0_1 ?z) f!219) (= (equivalence_lemma!946_arg_1_2 ?z) list!220))) )) (or (equivalence_lemma!946 f!219 list!220) (forall ((?z I_equivalence_lemma!946)) (not (and (= (equivalence_lemma!946_arg_0_1 ?z) f!219) (= (equivalence_lemma!946_arg_1_2 ?z) list!220))) ))) (or (equivalence_lemma_induct!968 f!219 (t!933 list!220)) (forall ((?z I_equivalence_lemma_induct!968)) (not (and (= (equivalence_lemma_induct!968_arg_0_7 ?z) f!219) (= (equivalence_lemma_induct!968_arg_1_8 ?z) (t!933 list!220)))) ))) (ite ((_ is Nil!934) list!220) (or (equivalence_lemma!946 f!219 list!220) (forall ((?z I_equivalence_lemma!946)) (not (and (= (equivalence_lemma!946_arg_0_1 ?z) f!219) (= (equivalence_lemma!946_arg_1_2 ?z) list!220))) )) error_value!981))) ))
(check-sat)
(exit)
