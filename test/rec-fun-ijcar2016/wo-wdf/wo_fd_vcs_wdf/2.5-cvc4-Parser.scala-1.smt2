...
(assert (exists ((l!205 TokenList!939)) (not (or (bvsge (ite ((_ is Nil!943) l!205) (_ bv0 32) (ite ((_ is Cons!940) l!205) (bvadd (_ bv1 32) (size!206 (tail!942 l!205))) error_value!954)) (_ bv0 32)) (not (ite ((_ is Nil!943) l!205) true (ite ((_ is Cons!940) l!205) (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!942 l!205))) )) true))))) ))
(check-sat)
(exit)
