...
(assert (exists ((l1!207 TokenList!969) (l2!208 TokenList!969)) (not (or (= (size!206 (ite ((_ is Nil!973) l1!207) l2!208 (ite ((_ is Cons!970) l1!207) (Cons!970 (head!971 l1!207) (append!209 (tail!972 l1!207) l2!208)) error_value!985))) (bvadd (size!206 l1!207) (size!206 l2!208))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (ite ((_ is Nil!973) l1!207) l2!208 (ite ((_ is Cons!970) l1!207) (Cons!970 (head!971 l1!207) (append!209 (tail!972 l1!207) l2!208)) error_value!985)))) ) (not (ite ((_ is Nil!973) l1!207) true (ite ((_ is Cons!970) l1!207) (not (forall ((?z I_append!209)) (not (and (= (append!209_arg_0_2 ?z) (tail!972 l1!207)) (= (append!209_arg_1_3 ?z) l2!208))) )) true))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l1!207)) ) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l2!208)) ))) ))
(check-sat)
(exit)
