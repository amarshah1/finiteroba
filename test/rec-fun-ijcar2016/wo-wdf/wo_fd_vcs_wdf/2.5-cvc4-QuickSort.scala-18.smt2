...
(assert (exists ((list!235 List!1123) (n!234 (_ BitVec 32))) (not (=> ((_ is Nil!1127) list!235) (or (ite ((_ is Some!1130) (max!216 (smaller!233 n!234 list!235))) (or (bvsgt n!234 (i!1131 (max!216 (smaller!233 n!234 list!235)))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) )) (or (ite ((_ is None!1129) (max!216 (smaller!233 n!234 list!235))) true error_value!1135) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) )))) ))
(check-sat)
(exit)
