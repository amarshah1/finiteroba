...
(assert (exists ((m!504 Nat!2484) (n!503 Nat!2484)) (not (or (or (not (and (leq!234 m!504 n!503) (not (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) m!504) (= (leq!234_arg_1_2 ?z) n!503))) )))) (not (and (leq!234 m!504 n!503) (not (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) m!504) (= (leq!234_arg_1_2 ?z) n!503))) ))))) (or (leq!234 m!504 (succ!2485 n!503)) (forall ((?z I_leq!234)) (not (and (= (leq!234_arg_0_1 ?z) m!504) (= (leq!234_arg_1_2 ?z) (succ!2485 n!503)))) )))) ))
(check-sat)
(exit)
