...
(assert (exists ((f!221 Formula!1320)) (not (=> (and (and (and (and ((_ is And!1321) f!221) ((_ is And!1321) f!221)) (and (isSimplified!208 f!221) (not (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) f!221)) )))) (=> (or (isSimplified!208 (lhs!1322 f!221)) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (lhs!1322 f!221))) )) (and (= (simplify!206 (lhs!1322 f!221)) (lhs!1322 f!221)) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (lhs!1322 f!221))) ))))) (=> (or (isSimplified!208 (rhs!1323 f!221)) (forall ((?z I_isSimplified!208)) (not (= (isSimplified!208_arg_0_1 ?z) (rhs!1323 f!221))) )) (and (= (simplify!206 (rhs!1323 f!221)) (rhs!1323 f!221)) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (rhs!1323 f!221))) ))))) (or (= (simplify!206 f!221) f!221) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) f!221)) )))) ))
(check-sat)
(exit)
