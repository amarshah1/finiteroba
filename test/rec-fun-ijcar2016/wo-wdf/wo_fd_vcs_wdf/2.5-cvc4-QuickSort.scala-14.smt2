...
(assert (exists ((list!229 List!1079) (n!228 (_ BitVec 32))) (not (=> ((_ is Nil!1083) list!229) (or (ite ((_ is Some!1086) (min!214 (greater!227 n!228 list!229))) (or (bvslt n!228 (i!1087 (min!214 (greater!227 n!228 list!229)))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 n!228 list!229))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) n!228) (= (greater!227_arg_1_3 ?z) list!229))) )) (or (ite ((_ is None!1085) (min!214 (greater!227 n!228 list!229))) true error_value!1091) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 n!228 list!229))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) n!228) (= (greater!227_arg_1_3 ?z) list!229))) ))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (greater!227 n!228 list!229))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_2 ?z) n!228) (= (greater!227_arg_1_3 ?z) list!229))) )))) ))
(check-sat)
(exit)
