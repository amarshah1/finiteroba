...
(assert (exists ((t!211 Tree!1000)) (not (or (bvsge (ite ((_ is IntLitTree!1004) t!211) (_ bv1 32) (ite ((_ is PlusTree!1009) t!211) (bvadd (bvadd (_ bv1 32) (treeSize!212 (left!1010 t!211))) (treeSize!212 (right!1011 t!211))) (ite ((_ is MinusTree!1006) t!211) (bvadd (bvadd (_ bv1 32) (treeSize!212 (left!1007 t!211))) (treeSize!212 (right!1008 t!211))) (ite ((_ is TimesTree!1012) t!211) (bvadd (bvadd (_ bv1 32) (treeSize!212 (left!1013 t!211))) (treeSize!212 (right!1014 t!211))) (ite ((_ is DivTree!1001) t!211) (bvadd (bvadd (_ bv1 32) (treeSize!212 (left!1002 t!211))) (treeSize!212 (right!1003 t!211))) error_value!1016))))) (_ bv0 32)) (not (ite ((_ is IntLitTree!1004) t!211) true (ite ((_ is PlusTree!1009) t!211) (and (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (left!1010 t!211))) )) (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (right!1011 t!211))) ))) (ite ((_ is MinusTree!1006) t!211) (and (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (left!1007 t!211))) )) (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (right!1008 t!211))) ))) (ite ((_ is TimesTree!1012) t!211) (and (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (left!1013 t!211))) )) (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (right!1014 t!211))) ))) (ite ((_ is DivTree!1001) t!211) (and (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (left!1002 t!211))) )) (not (forall ((?z I_treeSize!212)) (not (= (treeSize!212_arg_0_1 ?z) (right!1003 t!211))) ))) true)))))))) ))
(check-sat)
(exit)
