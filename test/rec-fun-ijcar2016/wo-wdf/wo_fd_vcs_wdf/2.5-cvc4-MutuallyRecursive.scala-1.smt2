...
(assert (exists ((n!206 (_ BitVec 32))) (not (or (= (ite (bvsle n!206 (_ bv0 32)) (_ bv1 32) (f!205 (bvsub n!206 (_ bv1 32)))) (fib!209 (bvadd n!206 (_ bv1 32)))) (not (ite (bvsle n!206 (_ bv0 32)) true (not (forall ((?z I_f!205)) (not (= (f!205_arg_0_1 ?z) (bvsub n!206 (_ bv1 32)))) )))) (forall ((?z I_fib!209)) (not (= (fib!209_arg_0_3 ?z) (bvadd n!206 (_ bv1 32)))) ))) ))
(check-sat)
(exit)
