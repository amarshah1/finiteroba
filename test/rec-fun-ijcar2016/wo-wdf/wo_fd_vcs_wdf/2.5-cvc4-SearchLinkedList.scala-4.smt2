...
(assert (exists ((list!210 List!909)) (not (and (and (or (>= (ite ((_ is Nil!913) list!210) (- 0) (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) (- 0) (+ (firstZero!211 (tail!912 list!210)) 1)) error_value!918)) (- 0)) (not (ite ((_ is Nil!913) list!210) true (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) true (not (forall ((?z I_firstZero!211)) (not (= (firstZero!211_arg_0_1 ?z) (tail!912 list!210))) ))) true)))) (or (>= (ite ((_ is Nil!913) list!210) (- 0) (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) (- 0) (+ (firstZero!211 (tail!912 list!210)) 1)) error_value!918)) (- 0)) (not (ite ((_ is Nil!913) list!210) true (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) true (not (forall ((?z I_firstZero!211)) (not (= (firstZero!211_arg_0_1 ?z) (tail!912 list!210))) ))) true))))) (or (ite (contains!209 list!210 (_ bv0 32)) (or (firstZeroAtPos!214 list!210 (ite ((_ is Nil!913) list!210) (- 0) (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) (- 0) (+ (firstZero!211 (tail!912 list!210)) 1)) error_value!918))) (forall ((?z I_firstZeroAtPos!214)) (not (and (= (firstZeroAtPos!214_arg_0_4 ?z) list!210) (= (firstZeroAtPos!214_arg_1_5 ?z) (ite ((_ is Nil!913) list!210) (- 0) (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) (- 0) (+ (firstZero!211 (tail!912 list!210)) 1)) error_value!918))))) ) (not (ite ((_ is Nil!913) list!210) true (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) true (not (forall ((?z I_firstZero!211)) (not (= (firstZero!211_arg_0_1 ?z) (tail!912 list!210))) ))) true)))) (or (= (ite ((_ is Nil!913) list!210) (- 0) (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) (- 0) (+ (firstZero!211 (tail!912 list!210)) 1)) error_value!918)) (size!206 list!210)) (not (ite ((_ is Nil!913) list!210) true (ite ((_ is Cons!910) list!210) (ite (= (head!911 list!210) (_ bv0 32)) true (not (forall ((?z I_firstZero!211)) (not (= (firstZero!211_arg_0_1 ?z) (tail!912 list!210))) ))) true))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_6 ?z) list!210)) ))) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_2 ?z) list!210) (= (contains!209_arg_1_3 ?z) (_ bv0 32)))) )))) ))
(check-sat)
(exit)
