...
(assert (exists ((x!422 Nat!2151) (xs!423 Lst!2155) (ys!424 Lst!2155)) (not (or (= (zip!288 (cons!2156 x!422 xs!423) ys!424) (ite (= ys!424 nil!2159) znil!2164 (zcons!2161 (mkpair!2166 x!422 (head!209 ys!424)) (zip!288 xs!423 (tail!211 ys!424))))) (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) (cons!2156 x!422 xs!423)) (= (zip!288_arg_1_2 ?z) ys!424))) ) (not (ite (= ys!424 nil!2159) true (and (not (forall ((?z I_head!209)) (not (= (head!209_arg_0_3 ?z) ys!424)) )) (not (forall ((?z I_zip!288)) (not (and (= (zip!288_arg_0_1 ?z) xs!423) (= (zip!288_arg_1_2 ?z) (tail!211 ys!424)))) )) (not (forall ((?z I_tail!211)) (not (= (tail!211_arg_0_4 ?z) ys!424)) ))))))) ))
(check-sat)
(exit)
