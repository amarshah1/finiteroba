...
(assert (exists ((f!217 Formula!1189)) (not (=> (and (and ((_ is Literal!1196) f!217) ((_ is Literal!1196) f!217)) (and (isNNF!212 f!217) (not (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) f!217)) )))) (or (isNNF!212 (simplify!206 f!217)) (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (simplify!206 f!217))) ) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) f!217)) )))) ))
(check-sat)
(exit)
