...
(assert (exists ((f!217 Formula!1206)) (not (=> (and (and (and ((_ is Not!1215) f!217) ((_ is Not!1215) f!217)) (and (isNNF!212 f!217) (not (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) f!217)) )))) (=> (or (isNNF!212 (f!1216 f!217)) (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (f!1216 f!217))) )) (and (isNNF!212 (simplify!206 (f!1216 f!217))) (not (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (simplify!206 (f!1216 f!217)))) )) (not (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) (f!1216 f!217))) ))))) (or (isNNF!212 (simplify!206 f!217)) (forall ((?z I_isNNF!212)) (not (= (isNNF!212_arg_0_1 ?z) (simplify!206 f!217))) ) (forall ((?z I_simplify!206)) (not (= (simplify!206_arg_0_2 ?z) f!217)) )))) ))
(check-sat)
(exit)
