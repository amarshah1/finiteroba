...
(assert (exists ((n!445 Nat!2288) (l!446 Lst!2292)) (not (or (= (count!263 n!445 l!446) (count!263 n!445 (rev!275 l!446))) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!445) (= (count!263_arg_1_2 ?z) l!446))) ) (forall ((?z I_count!263)) (not (and (= (count!263_arg_0_1 ?z) n!445) (= (count!263_arg_1_2 ?z) (rev!275 l!446)))) ) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_3 ?z) l!446)) ))) ))
(check-sat)
(exit)
