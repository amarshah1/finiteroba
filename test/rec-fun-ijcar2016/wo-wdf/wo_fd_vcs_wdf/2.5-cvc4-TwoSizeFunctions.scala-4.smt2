...
(assert (exists ((acc!210 Int) (l!209 List!894)) (not (=> (>= acc!210 (- 0)) (or (= (ite ((_ is Nil!898) l!209) acc!210 (ite ((_ is Cons!895) l!209) (size2acc!211 (tail!897 l!209) (+ acc!210 1)) error_value!901)) (+ (size1!206 l!209) acc!210)) (not (ite ((_ is Nil!898) l!209) true (ite ((_ is Cons!895) l!209) (not (forall ((?z I_size2acc!211)) (not (and (= (size2acc!211_arg_0_1 ?z) (tail!897 l!209)) (= (size2acc!211_arg_1_2 ?z) (+ acc!210 1)))) )) true))) (forall ((?z I_size1!206)) (not (= (size1!206_arg_0_3 ?z) l!209)) )))) ))
(check-sat)
(exit)
