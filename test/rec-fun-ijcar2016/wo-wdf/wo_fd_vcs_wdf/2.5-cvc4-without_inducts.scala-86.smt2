...
(assert (exists ((i!454 Nat!2319) (j!455 Nat!2319) (k!456 Nat!2319)) (not (or (= (minus!240 (minus!240 i!454 j!455) k!456) (minus!240 (minus!240 i!454 k!456) j!455)) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (minus!240 i!454 j!455)) (= (minus!240_arg_1_2 ?z) k!456))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) i!454) (= (minus!240_arg_1_2 ?z) j!455))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) (minus!240 i!454 k!456)) (= (minus!240_arg_1_2 ?z) j!455))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_1 ?z) i!454) (= (minus!240_arg_1_2 ?z) k!456))) ))) ))
(check-sat)
(exit)
