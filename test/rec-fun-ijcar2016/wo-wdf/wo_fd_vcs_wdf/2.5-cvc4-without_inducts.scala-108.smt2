...
(assert (exists ((l!529 Lst!2565) (x!528 Nat!2570)) (not (or (or (not (and (sorted!283 l!529) (not (forall ((?z I_sorted!283)) (not (= (sorted!283_arg_0_1 ?z) l!529)) )))) (not (and (sorted!283 l!529) (not (forall ((?z I_sorted!283)) (not (= (sorted!283_arg_0_1 ?z) l!529)) ))))) (or (sorted!283 (insort!281 x!528 l!529)) (forall ((?z I_sorted!283)) (not (= (sorted!283_arg_0_1 ?z) (insort!281 x!528 l!529))) ) (forall ((?z I_insort!281)) (not (and (= (insort!281_arg_0_6 ?z) x!528) (= (insort!281_arg_1_7 ?z) l!529))) )))) ))
(check-sat)
(exit)
