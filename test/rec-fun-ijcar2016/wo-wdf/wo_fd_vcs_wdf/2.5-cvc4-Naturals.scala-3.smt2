...
(assert (exists ((x!210 Nat!910)) (not (=> (and (and ((_ is Succ!911) x!210) ((_ is Succ!911) x!210)) (and (= (plus!207 (x!912 x!210) Zero!913) (x!912 x!210)) (not (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (x!912 x!210)) (= (plus!207_arg_1_2 ?z) Zero!913))) )))) (or (= (plus!207 x!210 Zero!913) x!210) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) x!210) (= (plus!207_arg_1_2 ?z) Zero!913))) )))) ))
(check-sat)
(exit)
