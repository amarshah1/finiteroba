...
(assert (exists ((l!224 List!1081)) (not (or (= (size!206 (ite ((_ is Nil!1085) l!224) Nil!1085 (ite ((_ is Cons!1082) l!224) (Cons!1082 (head!1083 l!224) (Cons!1082 (head!1083 l!224) (drunk!225 (tail!1084 l!224)))) error_value!1088))) (* 2 (size!206 l!224))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (ite ((_ is Nil!1085) l!224) Nil!1085 (ite ((_ is Cons!1082) l!224) (Cons!1082 (head!1083 l!224) (Cons!1082 (head!1083 l!224) (drunk!225 (tail!1084 l!224)))) error_value!1088)))) ) (not (ite ((_ is Nil!1085) l!224) true (ite ((_ is Cons!1082) l!224) (not (forall ((?z I_drunk!225)) (not (= (drunk!225_arg_0_2 ?z) (tail!1084 l!224))) )) true))) (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) l!224)) ))) ))
(check-sat)
(exit)
