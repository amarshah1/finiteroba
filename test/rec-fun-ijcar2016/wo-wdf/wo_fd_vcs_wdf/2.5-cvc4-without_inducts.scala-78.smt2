...
(assert (exists ((a!433 Tree!2228)) (not (or (= (height!303 (mirror!301 a!433)) (height!303 a!433)) (forall ((?z I_height!303)) (not (= (height!303_arg_0_1 ?z) (mirror!301 a!433))) ) (forall ((?z I_mirror!301)) (not (= (mirror!301_arg_0_6 ?z) a!433)) ) (forall ((?z I_height!303)) (not (= (height!303_arg_0_1 ?z) a!433)) ))) ))
(check-sat)
(exit)
