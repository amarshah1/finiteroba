...
(assert (exists ((t!218 IntTree!977)) (not (not (and (and (and (and (repOk!206 t!218) (not (forall ((?z I_repOk!206)) (not (= (repOk!206_arg_0_1 ?z) t!218)) ))) (and (repOk!206 t!218) (not (forall ((?z I_repOk!206)) (not (= (repOk!206_arg_0_1 ?z) t!218)) )))) (and (computesPositive!215 t!218) (not (forall ((?z I_computesPositive!215)) (not (= (computesPositive!215_arg_0_2 ?z) t!218)) )))) (and (identityForPositive!217 t!218) (not (forall ((?z I_identityForPositive!217)) (not (= (identityForPositive!217_arg_0_7 ?z) t!218)) )))))) ))
(check-sat)
(exit)
