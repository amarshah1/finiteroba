...
(assert (exists ((i!517 Nat!2528) (xs!518 Lst!2532)) (not (or (= (rev!275 (take!260 i!517 xs!518)) (drop!257 (minus!240 (len!254 xs!518) i!517) (rev!275 xs!518))) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_1 ?z) (take!260 i!517 xs!518))) ) (forall ((?z I_take!260)) (not (and (= (take!260_arg_0_4 ?z) i!517) (= (take!260_arg_1_5 ?z) xs!518))) ) (forall ((?z I_drop!257)) (not (and (= (drop!257_arg_0_6 ?z) (minus!240 (len!254 xs!518) i!517)) (= (drop!257_arg_1_7 ?z) (rev!275 xs!518)))) ) (forall ((?z I_minus!240)) (not (and (= (minus!240_arg_0_8 ?z) (len!254 xs!518)) (= (minus!240_arg_1_9 ?z) i!517))) ) (forall ((?z I_len!254)) (not (= (len!254_arg_0_10 ?z) xs!518)) ) (forall ((?z I_rev!275)) (not (= (rev!275_arg_0_1 ?z) xs!518)) ))) ))
(check-sat)
(exit)
