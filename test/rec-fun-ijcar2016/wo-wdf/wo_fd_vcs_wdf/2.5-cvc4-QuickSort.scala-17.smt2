...
(assert (exists ((list!235 List!1109) (n!234 (_ BitVec 32))) (not (=> (and (and ((_ is Cons!1110) list!235) ((_ is Cons!1110) list!235)) (and (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 (tail!1112 list!235)))) (and (bvsgt n!234 (i!1117 (max!216 (smaller!233 n!234 (tail!1112 list!235))))) (not (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (tail!1112 list!235)))) )) (not (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (tail!1112 list!235)))) ))) (and (ite ((_ is None!1115) (max!216 (smaller!233 n!234 (tail!1112 list!235)))) true error_value!1121) (not (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (tail!1112 list!235)))) )) (not (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (tail!1112 list!235)))) )))) (not (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 (tail!1112 list!235)))) )) (not (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) (tail!1112 list!235)))) )))) (or (ite ((_ is Some!1116) (max!216 (smaller!233 n!234 list!235))) (or (bvsgt n!234 (i!1117 (max!216 (smaller!233 n!234 list!235)))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) )) (or (ite ((_ is None!1115) (max!216 (smaller!233 n!234 list!235))) true error_value!1122) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) ))) (forall ((?z I_max!216)) (not (= (max!216_arg_0_1 ?z) (smaller!233 n!234 list!235))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_2 ?z) n!234) (= (smaller!233_arg_1_3 ?z) list!235))) )))) ))
(check-sat)
(exit)
