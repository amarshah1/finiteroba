...
(assert (exists ((x!221 Nat!955) (y!222 Nat!955)) (not (=> ((_ is Zero!958) x!221) (or (= (plus!207 (Succ!956 y!222) x!221) (Succ!956 (plus!207 y!222 x!221))) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) (Succ!956 y!222)) (= (plus!207_arg_1_2 ?z) x!221))) ) (forall ((?z I_plus!207)) (not (and (= (plus!207_arg_0_1 ?z) y!222) (= (plus!207_arg_1_2 ?z) x!221))) )))) ))
(check-sat)
(exit)
