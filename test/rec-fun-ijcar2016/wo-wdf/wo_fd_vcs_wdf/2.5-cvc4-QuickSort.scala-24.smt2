...
(assert (exists ((list!244 List!1192) (n!243 (_ BitVec 32))) (not (=> (and (and ((_ is Cons!1193) list!244) ((_ is Cons!1193) list!244)) (and (ite ((_ is Some!1199) (min!214 (equals!239 n!243 (tail!1195 list!244)))) (and (= n!243 (i!1200 (min!214 (equals!239 n!243 (tail!1195 list!244))))) (not (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 (tail!1195 list!244)))) )) (not (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) (tail!1195 list!244)))) ))) (and (ite ((_ is None!1198) (min!214 (equals!239 n!243 (tail!1195 list!244)))) true error_value!1204) (not (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 (tail!1195 list!244)))) )) (not (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) (tail!1195 list!244)))) )))) (not (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 (tail!1195 list!244)))) )) (not (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) (tail!1195 list!244)))) )))) (or (ite ((_ is Some!1199) (min!214 (equals!239 n!243 list!244))) (or (= n!243 (i!1200 (min!214 (equals!239 n!243 list!244)))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 list!244))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) list!244))) )) (or (ite ((_ is None!1198) (min!214 (equals!239 n!243 list!244))) true error_value!1205) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 list!244))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) list!244))) ))) (forall ((?z I_min!214)) (not (= (min!214_arg_0_1 ?z) (equals!239 n!243 list!244))) ) (forall ((?z I_equals!239)) (not (and (= (equals!239_arg_0_2 ?z) n!243) (= (equals!239_arg_1_3 ?z) list!244))) )))) ))
(check-sat)
(exit)
